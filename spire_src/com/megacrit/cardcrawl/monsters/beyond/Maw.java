...
public class Maw extends AbstractMonster {
      ...
      switch (this.nextMove) {
         case 2:
            ...
            AbstractDungeon.actionManager
               .addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, new WeakPower(AbstractDungeon.player, this.terrifyDur, true), this.terrifyDur));
            AbstractDungeon.actionManager
               .addToBottom(new ApplyPowerAction(AbstractDungeon.player, this, new FrailPower(AbstractDungeon.player, this.terrifyDur, true), this.terrifyDur));
            this.roared = true;
            break;
         case 3:
   ...
   protected void getMove(int num) {
      ...
      } else if (num < 50 && !this.lastMove((byte)5)) {
         if (this.turnCount / 2 <= 1) {
            this.setMove((byte)5, AbstractMonster.Intent.ATTACK, this.damage.get(1).base);
         } else {
            int var10004 = this.turnCount / 2;
            this.setMove((byte)5, AbstractMonster.Intent.ATTACK, this.damage.get(1).base, var10004, true);
         }
      } else if (!this.lastMove((byte)3) && !this.lastMove((byte)5)) {
