...
public final class GL11 {
   ...
   public static boolean glAreTexturesResident(IntBuffer textures, ByteBuffer residences) {
      ...
      return nglAreTexturesResident(textures.remaining(), MemoryUtil.getAddress(textures), MemoryUtil.getAddress(residences), function_pointer);
   }
   ...
   public static int glGetError() {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetError(function_pointer);
   }
   ...
   public static int glGenLists(int range) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGenLists(range, function_pointer);
   }
   ...
   public static boolean glIsEnabled(int cap) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsEnabled(cap, function_pointer);
   }
   ...
   public static String glGetString(int name) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetString(name, function_pointer);
   }
   ...
   public static boolean glIsList(int list) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsList(list, function_pointer);
   }
   ...
   public static boolean glIsTexture(int texture) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsTexture(texture, function_pointer);
   }
   ...
   public static int glRenderMode(int mode) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglRenderMode(mode, function_pointer);
   }
   ...
   public static void glTexImage2D(
      int target, int level, int internalformat, int width, int height, int border, int format, int type, long pixels_buffer_offset
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
      long function_pointer = caps.glTexImage2D;
      BufferChecks.checkFunctionAddress(function_pointer);
