...
public class EnergyOrbRed implements EnergyOrbInterface {
   ...
   public void updateOrb(int orbCount) {
      if (orbCount == 0) {
         ...
         this.angle1 = this.angle1 + Gdx.graphics.getDeltaTime() * 72.0F;
      } else {
         ...
         this.angle1 = this.angle1 + Gdx.graphics.getDeltaTime() * 360.0F;
      }
   }
   ...
   public void renderOrb(SpriteBatch sb, boolean enabled, float current_x, float current_y) {
      if (enabled) {
         ...
         sb.setColor(Color.WHITE);
         sb.draw(
            ImageMaster.ENERGY_RED_LAYER1D,
            current_x - 64.0F,
            current_y - 64.0F,
            64.0F,
            64.0F,
         ...
         sb.draw(
            ImageMaster.ENERGY_RED_LAYER2D,
            current_x - 64.0F,
            current_y - 64.0F,
            64.0F,
            64.0F,
         ...
         sb.draw(
            ImageMaster.ENERGY_RED_LAYER3D,
            current_x - 64.0F,
            current_y - 64.0F,
            64.0F,
            64.0F,
         ...
         sb.draw(
            ImageMaster.ENERGY_RED_LAYER4D,
            current_x - 64.0F,
            current_y - 64.0F,
            64.0F,
            64.0F,
         ...
         sb.draw(
            ImageMaster.ENERGY_RED_LAYER5D,
            current_x - 64.0F,
            current_y - 64.0F,
            64.0F,
            64.0F,
