...
public class IntMap<V> implements Iterable<IntMap.Entry<V>> {
   ...
   public void putAll(IntMap<V> map) {
      for (IntMap.Entry<V> entry : map.entries()) {
   ...
   public static class Entries<V> extends IntMap.MapIterator<V> implements Iterable<IntMap.Entry<V>>, Iterator<IntMap.Entry<V>> {
   ...
   public static class Values<V> extends IntMap.MapIterator<V> implements Iterable<V>, Iterator<V> {
