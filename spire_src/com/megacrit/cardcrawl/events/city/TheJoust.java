...
public class TheJoust extends AbstractImageEvent {
   ...
   private TheJoust.CUR_SCREEN screen = TheJoust.CUR_SCREEN.HALT;
   ...
   public void update() {
      ...
      if (this.joustTimer != 0.0F) {
         this.joustTimer = this.joustTimer - Gdx.graphics.getDeltaTime();
         if (this.joustTimer < 0.0F) {
            this.clangCount++;
   ...
   protected void buttonEffect(int buttonPressed) {
      switch (this.screen) {
         case HALT:
            ...
            this.screen = TheJoust.CUR_SCREEN.EXPLANATION;
            break;
         case EXPLANATION:
            if (buttonPressed == 0) {
               this.betFor = false;
         ...
         case JOUST:
            ...
            this.screen = TheJoust.CUR_SCREEN.COMPLETE;
            break;
         case COMPLETE:
            this.openMap();
      }
