...
extends AbstractOutputStreamAppender<AbstractSocketManager> {
    ...
    public static SocketAppender createAppender(String host, int port, Protocol protocol, SslConfiguration sslConfig, int connectTimeoutMillis, int reconnectDelayMillis, boolean immediateFail, String name, boolean immediateFlush, boolean ignoreExceptions, Layout<? extends Serializable> layout, Filter filter, boolean advertise, Configuration configuration) {
        return ((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)((Builder)SocketAppender.newBuilder().withAdvertise(advertise)).setConfiguration(configuration)).withConnectTimeoutMillis(connectTimeoutMillis)).setFilter(filter)).withHost(host)).setIgnoreExceptions(ignoreExceptions)).withImmediateFail(immediateFail)).setLayout(layout)).setName(name)).withPort(port)).withProtocol(protocol)).withReconnectDelayMillis(reconnectDelayMillis)).withSslConfiguration(sslConfig)).build();
    }
