...
public class ScaledNumericValue extends RangedNumericValue {
   ...
   public void read(Json json, JsonValue jsonData) {
      ...
      this.highMin = json.readValue("highMin", float.class, jsonData);
      this.highMax = json.readValue("highMax", float.class, jsonData);
      this.relative = json.readValue("relative", boolean.class, jsonData);
