...
public final class APPLEVertexProgramEvaluators {
   ...
   public static boolean glIsVertexAttribEnabledAPPLE(int index, int pname) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsVertexAttribEnabledAPPLE(index, pname, function_pointer);
   }
   ...
   public static void glMapVertexAttrib2dAPPLE(
      int index, int size, double u1, double u2, int ustride, int uorder, double v1, double v2, int vstride, int vorder, DoubleBuffer points
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
   ...
   static native void nglMapVertexAttrib2dAPPLE(
      int var0, int var1, double var2, double var4, int var6, int var7, double var8, double var10, int var12, int var13, long var14, long var16
   );
   ...
   static native void nglMapVertexAttrib2fAPPLE(
      int var0, int var1, float var2, float var3, int var4, int var5, float var6, float var7, int var8, int var9, long var10, long var12
   );
}
