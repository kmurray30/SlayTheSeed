...
public class CollectorCurseEffect extends AbstractGameEffect {
   ...
   @Override
   public void update() {
      this.stakeTimer = this.stakeTimer - Gdx.graphics.getDeltaTime();
      if (this.stakeTimer < 0.0F) {
         ...
         AbstractDungeon.effectsQueue
            .add(new CollectorStakeEffect(this.x + MathUtils.random(-50.0F, 50.0F) * Settings.scale, this.y + MathUtils.random(-60.0F, 60.0F) * Settings.scale));
