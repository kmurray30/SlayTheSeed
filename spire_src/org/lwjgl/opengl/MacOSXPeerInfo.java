...
abstract class MacOSXPeerInfo extends PeerInfo {
   MacOSXPeerInfo(
      PixelFormat pixel_format, ContextAttribs attribs, boolean use_display_bpp, boolean support_window, boolean support_pbuffer, boolean double_buffered
   ) throws LWJGLException {
      super(createHandle());
      boolean gl32 = attribs != null
         && (3 < attribs.getMajorVersion() || attribs.getMajorVersion() == 3 && 2 <= attribs.getMinorVersion())
         && attribs.isProfileCore();
   ...
   private void choosePixelFormat(
      PixelFormat pixel_format, boolean gl32, boolean use_display_bpp, boolean support_window, boolean support_pbuffer, boolean double_buffered
   ) throws LWJGLException {
