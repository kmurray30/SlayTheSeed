...
public class DecalMaterial {
   ...
   public boolean equals(Object o) {
      if (o == null) {
         ...
         return this.dstBlendFactor == material.dstBlendFactor
            && this.srcBlendFactor == material.srcBlendFactor
            && this.textureRegion.getTexture() == material.textureRegion.getTexture();
      }
   }
   ...
   public int hashCode() {
      ...
      return 31 * result + this.dstBlendFactor;
   }
}
