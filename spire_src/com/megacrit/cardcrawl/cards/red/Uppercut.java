...
extends AbstractCard {
    ...
    public Uppercut() {
        super(ID, Uppercut.cardStrings.NAME, "red/attack/uppercut", 2, Uppercut.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.RED, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 13;
