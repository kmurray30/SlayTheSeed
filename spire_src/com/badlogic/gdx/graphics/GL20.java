...
public interface GL20 {
   ...
   void glUniform4fv(int var1, int var2, float[] var3, int var4);

   void glUniform4i(int var1, int var2, int var3, int var4, int var5);

   void glUniform4iv(int var1, int var2, IntBuffer var3);

   void glUniform4iv(int var1, int var2, int[] var3, int var4);

   void glUniformMatrix2fv(int var1, int var2, boolean var3, FloatBuffer var4);

   void glUniformMatrix2fv(int var1, int var2, boolean var3, float[] var4, int var5);

   void glUniformMatrix3fv(int var1, int var2, boolean var3, FloatBuffer var4);

   void glUniformMatrix3fv(int var1, int var2, boolean var3, float[] var4, int var5);

   void glUniformMatrix4fv(int var1, int var2, boolean var3, FloatBuffer var4);

   void glUniformMatrix4fv(int var1, int var2, boolean var3, float[] var4, int var5);
