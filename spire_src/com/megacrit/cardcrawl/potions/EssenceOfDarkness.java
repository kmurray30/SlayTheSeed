...
public class EssenceOfDarkness
extends AbstractPotion {
    ...
    public EssenceOfDarkness() {
        super(EssenceOfDarkness.potionStrings.NAME, POTION_ID, AbstractPotion.PotionRarity.RARE, AbstractPotion.PotionSize.MOON, AbstractPotion.PotionColor.SMOKE);
    ...
    public void initializeData() {
        ...
        this.description = EssenceOfDarkness.potionStrings.DESCRIPTIONS[0] + this.potency + EssenceOfDarkness.potionStrings.DESCRIPTIONS[1];
        this.tips.clear();
