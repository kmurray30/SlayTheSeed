...
public class ReprieveAction extends AbstractGameAction {
   ...
   public void update() {
      if (this.targetMonster != null
         && this.targetMonster.intent != AbstractMonster.Intent.ATTACK
         ...
         this.addToBot(
            new ApplyPowerAction(AbstractDungeon.player, AbstractDungeon.player, new FocusPower(AbstractDungeon.player, this.focusIncrease), this.focusIncrease)
         );
      } else {
