...
public class TextureAttribute extends Attribute {
   ...
   public <T extends Texture> TextureAttribute(
      long type, TextureDescriptor<T> textureDescription, float offsetU, float offsetV, float scaleU, float scaleV, int uvIndex
   ) {
   ...
   public int hashCode() {
      ...
      return 991 * result + this.uvIndex;
   }
   ...
   public int compareTo(Attribute o) {
      if (this.type != o.type) {
         ...
         if (c != 0) {
            return c;
         } else if (this.uvIndex != other.uvIndex) {
