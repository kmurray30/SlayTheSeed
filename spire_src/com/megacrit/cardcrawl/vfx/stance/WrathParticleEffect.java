...
public class WrathParticleEffect extends AbstractGameEffect {
   ...
   public WrathParticleEffect() {
      ...
      this.x = AbstractDungeon.player.hb.cX
         + MathUtils.random(-AbstractDungeon.player.hb.width / 2.0F - 30.0F * Settings.scale, AbstractDungeon.player.hb.width / 2.0F + 30.0F * Settings.scale);
      this.y = AbstractDungeon.player.hb.cY
         + MathUtils.random(
            -AbstractDungeon.player.hb.height / 2.0F - -10.0F * Settings.scale, AbstractDungeon.player.hb.height / 2.0F - 10.0F * Settings.scale
         );
   ...
   public void update() {
      ...
      this.vY = this.vY + Gdx.graphics.getDeltaTime() * 40.0F * Settings.scale;
   ...
   public void render(SpriteBatch sb) {
      ...
      sb.draw(
         ...
         this.scale * 0.8F,
         (0.1F + (this.dur_div2 * 2.0F - this.duration) * 2.0F * this.scale) * Settings.scale,
         this.rotation
      );
