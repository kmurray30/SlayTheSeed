...
public final class NVRegisterCombiners {
   ...
   public static void glCombinerOutputNV(
      int stage, int portion, int abOutput, int cdOutput, int sumOutput, int scale, int bias, boolean abDotProduct, boolean cdDotProduct, boolean muxSum
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
   ...
   static native void nglCombinerOutputNV(
      int var0, int var1, int var2, int var3, int var4, int var5, int var6, boolean var7, boolean var8, boolean var9, long var10
   );
