...
public final class NVPathRendering {
   ...
   public static void glPathCommandsNV(int path, ByteBuffer commands, int coordType, ByteBuffer coords) {
      ...
      nglPathCommandsNV(
         path, commands.remaining(), MemoryUtil.getAddress(commands), coords.remaining(), coordType, MemoryUtil.getAddress(coords), function_pointer
      );
   }
   ...
   public static void glPathSubCommandsNV(int path, int commandStart, int commandsToDelete, ByteBuffer commands, int coordType, ByteBuffer coords) {
      ...
      nglPathSubCommandsNV(
         ...
         commandsToDelete,
         commands.remaining(),
         MemoryUtil.getAddress(commands),
         coords.remaining(),
         coordType,
         MemoryUtil.getAddress(coords),
         function_pointer
      );
   }
   ...
   public static void glPathGlyphsNV(
      ...
      nglPathGlyphsNV(
         firstPathName,
         fontTarget,
         MemoryUtil.getAddress(fontName),
         fontStyle,
         charcodes.remaining() / GLChecks.calculateBytesPerCharCode(type),
         type,
         MemoryUtil.getAddress(charcodes),
         handleMissingGlyphs,
   ...
   public static int glGenPathsNV(int range) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGenPathsNV(range, function_pointer);
   }
   ...
   public static boolean glIsPathNV(int path) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsPathNV(path, function_pointer);
   }
   ...
   public static void glStencilFillPathInstancedNV(
      int pathNameType, ByteBuffer paths, int pathBase, int fillMode, int mask, int transformType, FloatBuffer transformValues
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
      ...
      nglStencilFillPathInstancedNV(
         paths.remaining() / GLChecks.calculateBytesPerPathName(pathNameType),
         pathNameType,
         MemoryUtil.getAddress(paths),
         pathBase,
         fillMode,
         mask,
         transformType,
         MemoryUtil.getAddressSafe(transformValues),
         function_pointer
      );
   }
   ...
   public static void glStencilStrokePathInstancedNV(
      int pathNameType, ByteBuffer paths, int pathBase, int reference, int mask, int transformType, FloatBuffer transformValues
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
   ...
   public static void glPathTexGenNV(int texCoordSet, int genMode, FloatBuffer coeffs) {
      ...
      nglPathTexGenNV(
         texCoordSet, genMode, GLChecks.calculatePathTextGenCoeffsPerComponent(coeffs, genMode), MemoryUtil.getAddressSafe(coeffs), function_pointer
      );
   }
   ...
   public static void glCoverFillPathInstancedNV(
      int pathNameType, ByteBuffer paths, int pathBase, int coverMode, int transformType, FloatBuffer transformValues
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
   ...
   public static void glGetPathSpacingNV(
      ...
      nglGetPathSpacingNV(
         ...
         kerningScale,
         transformType,
         MemoryUtil.getAddress(returnedSpacing),
         function_pointer
      );
   }
   ...
   public static boolean glIsPointInFillPathNV(int path, int mask, float x, float y) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsPointInFillPathNV(path, mask, x, y, function_pointer);
   }
   ...
   public static boolean glIsPointInStrokePathNV(int path, float x, float y) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsPointInStrokePathNV(path, x, y, function_pointer);
   }
   ...
   public static float glGetPathLengthNV(int path, int startSegment, int numSegments) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetPathLengthNV(path, startSegment, numSegments, function_pointer);
   }

   static native float nglGetPathLengthNV(int var0, int var1, int var2, long var3);

   public static boolean glPointAlongPathNV(
      int path, int startSegment, int numSegments, float distance, FloatBuffer x, FloatBuffer y, FloatBuffer tangentX, FloatBuffer tangentY
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
      ...
      return nglPointAlongPathNV(
         ...
         numSegments,
         distance,
         MemoryUtil.getAddressSafe(x),
         MemoryUtil.getAddressSafe(y),
         MemoryUtil.getAddressSafe(tangentX),
         MemoryUtil.getAddressSafe(tangentY),
         function_pointer
      );
   }
