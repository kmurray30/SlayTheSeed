...
public class PotionBounceEffect extends AbstractGameEffect {
   ...
   public void update() {
      ...
      this.previousPos
         .add(
            new Vector2(this.cX + MathUtils.random(-30.0F, 30.0F) * Settings.scale, this.cY + this.yOffset + MathUtils.random(-30.0F, 30.0F) * Settings.scale)
         );
