...
public class FlameParticleEffect extends AbstractGameEffect {
   ...
   public FlameParticleEffect(float x, float y) {
      ...
      this.color.b = this.color.b - (this.color.g - MathUtils.random(0.5F));
   ...
   public void update() {
      if (this.delayTimer > 0.0F) {
         ...
         this.vY = this.vY * (59.0F * Gdx.graphics.getDeltaTime());
         this.scale = this.scale + this.vS * Gdx.graphics.getDeltaTime();
