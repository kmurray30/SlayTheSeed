...
public class DEPRECATEDConfront
extends AbstractCard {
    ...
    public DEPRECATEDConfront() {
        super(ID, DEPRECATEDConfront.cardStrings.NAME, null, 1, DEPRECATEDConfront.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.PURPLE, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 8;
        this.exhaust = true;
    }
