...
class LwjglGL20 implements GL20 {
   ...
   private IntBuffer toIntBuffer(int[] v, int offset, int count) {
      ...
      BufferUtils.copy(v, count, offset, this.intBuffer);
   ...
   public void glDrawElements(int mode, int count, int type, Buffer indices) {
      if (indices instanceof ShortBuffer && type == 5123) {
         ...
         if (!(indices instanceof ByteBuffer) || type != 5121) {
   ...
   public String glGetActiveAttrib(int program, int index, IntBuffer size, Buffer type) {
      ...
      String name = org.lwjgl.opengl.GL20.glGetActiveAttrib(program, index, 256, typeTmp);
   ...
   public String glGetActiveUniform(int program, int index, IntBuffer size, Buffer type) {
      IntBuffer typeTmp = org.lwjgl.BufferUtils.createIntBuffer(2);
      String name = org.lwjgl.opengl.GL20.glGetActiveUniform(program, index, 256, typeTmp);
      size.put(typeTmp.get(0));
      if (type instanceof IntBuffer) {
         ((IntBuffer)type).put(typeTmp.get(1));
      }
   ...
   public void glGetAttachedShaders(int program, int maxcount, Buffer count, IntBuffer shaders) {
      org.lwjgl.opengl.GL20.glGetAttachedShaders(program, (IntBuffer)count, shaders);
   }
   ...
   public String glGetProgramInfoLog(int program) {
      ...
      org.lwjgl.opengl.GL20.glGetProgramInfoLog(program, intBuffer, buffer);
   ...
   public String glGetShaderInfoLog(int shader) {
      ...
      tmp.order(ByteOrder.nativeOrder());
      IntBuffer intBuffer = tmp.asIntBuffer();
      org.lwjgl.opengl.GL20.glGetShaderInfoLog(shader, intBuffer, buffer);
      int numBytes = intBuffer.get(0);
      byte[] bytes = new byte[numBytes];
      buffer.get(bytes);
      return new String(bytes);
      ...
      if (pixels instanceof ByteBuffer) {
         ...
         if (!(pixels instanceof FloatBuffer)) {
            throw new GdxRuntimeException(
               "Can't use " + pixels.getClass().getName() + " with this method. Use ByteBuffer, ShortBuffer, IntBuffer or FloatBuffer instead. Blame LWJGL"
            );
         }
   ...
   public void glUniform1fv(int location, int count, FloatBuffer v) {
      org.lwjgl.opengl.GL20.glUniform1(location, v);
   }

   @Override
   public void glUniform1fv(int location, int count, float[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform1(location, this.toFloatBuffer(v, offset, count));
   }
   ...
   public void glUniform1iv(int location, int count, int[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform1(location, this.toIntBuffer(v, offset, count));
   }
   ...
   public void glUniform2fv(int location, int count, FloatBuffer v) {
      org.lwjgl.opengl.GL20.glUniform2(location, v);
   }

   @Override
   public void glUniform2fv(int location, int count, float[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform2(location, this.toFloatBuffer(v, offset, count << 1));
   }
   ...
   public void glUniform2iv(int location, int count, int[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform2(location, this.toIntBuffer(v, offset, count << 1));
   }
   ...
   public void glUniform3fv(int location, int count, FloatBuffer v) {
      org.lwjgl.opengl.GL20.glUniform3(location, v);
   }

   @Override
   public void glUniform3fv(int location, int count, float[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform3(location, this.toFloatBuffer(v, offset, count * 3));
   }
   ...
   public void glUniform3iv(int location, int count, int[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform3(location, this.toIntBuffer(v, offset, count * 3));
   }
   ...
   public void glUniform4fv(int location, int count, FloatBuffer v) {
      org.lwjgl.opengl.GL20.glUniform4(location, v);
   }

   @Override
   public void glUniform4fv(int location, int count, float[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform4(location, this.toFloatBuffer(v, offset, count << 2));
   }
   ...
   public void glUniform4iv(int location, int count, int[] v, int offset) {
      org.lwjgl.opengl.GL20.glUniform4(location, this.toIntBuffer(v, offset, count << 2));
   }

   @Override
   public void glUniformMatrix2fv(int location, int count, boolean transpose, FloatBuffer value) {
      org.lwjgl.opengl.GL20.glUniformMatrix2(location, transpose, value);
   }

   @Override
   public void glUniformMatrix2fv(int location, int count, boolean transpose, float[] value, int offset) {
      org.lwjgl.opengl.GL20.glUniformMatrix2(location, transpose, this.toFloatBuffer(value, offset, count << 2));
   }

   @Override
   public void glUniformMatrix3fv(int location, int count, boolean transpose, FloatBuffer value) {
      org.lwjgl.opengl.GL20.glUniformMatrix3(location, transpose, value);
   }

   @Override
   public void glUniformMatrix3fv(int location, int count, boolean transpose, float[] value, int offset) {
      org.lwjgl.opengl.GL20.glUniformMatrix3(location, transpose, this.toFloatBuffer(value, offset, count * 9));
   }

   @Override
   public void glUniformMatrix4fv(int location, int count, boolean transpose, FloatBuffer value) {
      org.lwjgl.opengl.GL20.glUniformMatrix4(location, transpose, value);
   }

   @Override
   public void glUniformMatrix4fv(int location, int count, boolean transpose, float[] value, int offset) {
      org.lwjgl.opengl.GL20.glUniformMatrix4(location, transpose, this.toFloatBuffer(value, offset, count << 4));
   }
   ...
   public void glVertexAttrib1fv(int indx, FloatBuffer values) {
      org.lwjgl.opengl.GL20.glVertexAttrib1f(indx, values.get());
   }
   ...
   public void glVertexAttrib2fv(int indx, FloatBuffer values) {
      org.lwjgl.opengl.GL20.glVertexAttrib2f(indx, values.get(), values.get());
   }
   ...
   public void glVertexAttrib3fv(int indx, FloatBuffer values) {
      org.lwjgl.opengl.GL20.glVertexAttrib3f(indx, values.get(), values.get(), values.get());
   }
   ...
   public void glVertexAttrib4fv(int indx, FloatBuffer values) {
      org.lwjgl.opengl.GL20.glVertexAttrib4f(indx, values.get(), values.get(), values.get(), values.get());
   }
   ...
   public void glVertexAttribPointer(int indx, int size, int type, boolean normalized, int stride, Buffer buffer) {
      if (buffer instanceof ByteBuffer) {
         if (type == 5120) {
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, false, normalized, stride, (ByteBuffer)buffer);
         } else if (type == 5121) {
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, true, normalized, stride, (ByteBuffer)buffer);
         } else if (type == 5122) {
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, false, normalized, stride, ((ByteBuffer)buffer).asShortBuffer());
         } else if (type == 5123) {
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, true, normalized, stride, ((ByteBuffer)buffer).asShortBuffer());
         } else {
            if (type != 5126) {
               throw new GdxRuntimeException(
                  "Can't use "
            ...
            org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, normalized, stride, ((ByteBuffer)buffer).asFloatBuffer());
         }
      } else {
         ...
         if (type != 5126) {
            throw new GdxRuntimeException("Can't use " + buffer.getClass().getName() + " with type " + type + " with this method.");
         }

         org.lwjgl.opengl.GL20.glVertexAttribPointer(indx, size, normalized, stride, (FloatBuffer)buffer);
      }
   }
