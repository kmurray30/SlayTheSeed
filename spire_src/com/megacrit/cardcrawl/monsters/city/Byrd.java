         ...
         case 1:
            ...
            for (int i = 0; i < this.peckCount; i++) {
               ...
               AbstractDungeon.actionManager
                  .addToBottom(new DamageAction(AbstractDungeon.player, this.damage.get(0), AbstractGameAction.AttackEffect.BLUNT_LIGHT, true));
            }
            break;
         case 2:
            this.isFlying = true;
   ...
   protected void getMove(int num) {
      if (this.firstMove) {
         ...
         if (AbstractDungeon.aiRng.randomBoolean(0.375F)) {
            ...
            this.setMove((byte)1, AbstractMonster.Intent.ATTACK, this.damage.get(0).base, this.peckCount, true);
         }
      } else {
         if (this.isFlying) {
            if (num < 50) {
            ...
            this.setMove((byte)5, AbstractMonster.Intent.ATTACK, this.damage.get(2).base);
         }
      }
   }
