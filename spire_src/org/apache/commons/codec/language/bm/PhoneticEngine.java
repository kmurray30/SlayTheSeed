      ...
      if (finalRules == null) {
         ...
         for (Rule.Phoneme phoneme : phonemeBuilder.getPhonemes()) {
            ...
            while (i < phonemeText.length()) {
               PhoneticEngine.RulesApplication rulesApplication = new PhoneticEngine.RulesApplication(finalRules, phonemeText, subBuilder, i, this.maxPhonemes)
                  .invoke();
            ...
            for (Rule.Phoneme newPhoneme : subBuilder.getPhonemes()) {
               if (phonemes.containsKey(newPhoneme)) {
                  Rule.Phoneme oldPhoneme = phonemes.remove(newPhoneme);
