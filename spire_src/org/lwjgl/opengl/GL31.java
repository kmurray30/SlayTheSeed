...
public final class GL31 {
   ...
   public static void glGetActiveUniformName(int program, int uniformIndex, IntBuffer length, ByteBuffer uniformName) {
      ...
      nglGetActiveUniformName(
         program, uniformIndex, uniformName.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(uniformName), function_pointer
      );
   }
   ...
   public static String glGetActiveUniformName(int program, int uniformIndex, int bufSize) {
      ...
      ((Buffer)uniformName).limit(uniformName_length.get(0));
   ...
   public static int glGetUniformBlockIndex(int program, ByteBuffer uniformBlockName) {
      ...
      return nglGetUniformBlockIndex(program, MemoryUtil.getAddress(uniformBlockName), function_pointer);
   }
   ...
   public static int glGetUniformBlockIndex(int program, CharSequence uniformBlockName) {
      ...
      long function_pointer = caps.glGetUniformBlockIndex;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetUniformBlockIndex(program, APIUtil.getBufferNT(caps, uniformBlockName), function_pointer);
   }
   ...
   public static void glGetActiveUniformBlockName(int program, int uniformBlockIndex, IntBuffer length, ByteBuffer uniformBlockName) {
      ...
      nglGetActiveUniformBlockName(
         program, uniformBlockIndex, uniformBlockName.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(uniformBlockName), function_pointer
      );
   }
   ...
   public static String glGetActiveUniformBlockName(int program, int uniformBlockIndex, int bufSize) {
      ...
      nglGetActiveUniformBlockName(
         program, uniformBlockIndex, bufSize, MemoryUtil.getAddress0(uniformBlockName_length), MemoryUtil.getAddress(uniformBlockName), function_pointer
      );
      ((Buffer)uniformBlockName).limit(uniformBlockName_length.get(0));
