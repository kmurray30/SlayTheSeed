...
public abstract class AbstractChest {
   ...
   public int GOLD_AMT;
   public AbstractChest.RelicReward relicReward;
   ...
   public void randomizeReward() {
      ...
      if (roll < this.COMMON_CHANCE) {
         this.relicReward = AbstractChest.RelicReward.COMMON_RELIC;
      } else if (roll < this.UNCOMMON_CHANCE + this.COMMON_CHANCE) {
         this.relicReward = AbstractChest.RelicReward.UNCOMMON_RELIC;
      } else {
         this.relicReward = AbstractChest.RelicReward.RARE_RELIC;
      }
   }
   ...
   public void render(SpriteBatch sb) {
      ...
      if (Settings.isControllerMode && !this.isOpen) {
         ...
         sb.draw(
            ...
            CHEST_LOC_X - 32.0F - 150.0F * Settings.scale,
            CHEST_LOC_Y - 32.0F - 210.0F * Settings.scale,
            32.0F,
            32.0F,
            64.0F,
            64.0F,
