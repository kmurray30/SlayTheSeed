...
public abstract class AbstractRelic implements Comparable<AbstractRelic> {
   ...
   private static final float START_Y = Settings.isMobile ? Settings.HEIGHT - 132.0F * Settings.scale : Settings.HEIGHT - 102.0F * Settings.scale;
   ...
   public AbstractRelic(String setId, String imgName, AbstractRelic.RelicTier tier, AbstractRelic.LandingSound sfx) {
   ...
   public void spawn(float x, float y) {
      ...
      this.isObtained = false;
      if (this.tier == AbstractRelic.RelicTier.BOSS) {
   ...
   public void render(SpriteBatch sb, boolean renderAmount, Color outlineColor) {
      ...
      if (AbstractDungeon.screen == null || AbstractDungeon.screen != AbstractDungeon.CurrentScreen.NEOW_UNLOCK) {
         ...
         sb.draw(
            this.largeImg,
            this.currentX - 128.0F,
            this.currentY - 128.0F,
            128.0F,
            128.0F,
            256.0F,
            256.0F,
            Settings.scale * 1.0F + MathUtils.cosDeg((float)(System.currentTimeMillis() / 5L % 360L)) / 30.0F,
            Settings.scale * 1.0F + MathUtils.cosDeg((float)(System.currentTimeMillis() / 5L % 360L)) / 30.0F,
            this.rotation,
            0,
            0,
      ...
      if (this.counter > -1) {
         if (inTopPanel) {
            FontHelper.renderFontRightTopAligned(
               ...
               offsetX + this.currentX + 30.0F * Settings.scale,
   ...
   public void renderOutline(SpriteBatch sb, boolean inTopPanel) {
      ...
      if (this.hb.hovered && Settings.isControllerMode) {
         ...
         sb.setColor(this.goldOutlineColor);
         sb.draw(
            this.outlineImg, tmpX, this.currentY - 64.0F, 64.0F, 64.0F, 128.0F, 128.0F, this.scale, this.scale, this.rotation, 0, 0, 128, 128, false, false
         );
         sb.setBlendFunction(770, 771);
      } else {
         sb.setColor(PASSIVE_OUTLINE_COLOR);
   ...
   public void renderFlash(SpriteBatch sb, boolean inTopPanel) {
      ...
      sb.draw(
         this.img, tmpX, this.currentY - 64.0F, 64.0F, 64.0F, 128.0F, 128.0F, this.scale + tmp, this.scale + tmp, this.rotation, 0, 0, 128, 128, false, false
      );
      sb.draw(
         this.img,
         tmpX,
