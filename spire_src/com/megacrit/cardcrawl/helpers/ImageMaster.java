...
public class ImageMaster {
   ...
   public static ArrayList<Texture> LIGHTNING_PASSIVE_VFX = new ArrayList<>();
   ...
   public static HashMap<String, Texture> relicImages = new HashMap<>();
   public static HashMap<String, Texture> relicOutlineImages = new HashMap<>();
   ...
   public static void loadRelicImg(String id, String imgUrl) {
      if (!relicImages.containsKey(id)) {
         relicImages.put(id, loadImage("images/relics/" + imgUrl));
         relicOutlineImages.put(id, loadImage("images/relics/outline/" + imgUrl));
      }
   }
   ...
   public static Texture loadImage(String imgUrl, boolean linearFiltering) {
      ...
      try {
         ...
         logger.info("[ERROR] " + var3.getMessage());
         return null;
      }
   }
}
