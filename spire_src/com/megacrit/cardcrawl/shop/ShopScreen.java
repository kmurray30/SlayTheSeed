...
public class ShopScreen {
    ...
    private float rugY = (float)Settings.HEIGHT / 2.0f + 540.0f * Settings.yScale;
    ...
    private void initRelics() {
        ...
        for (int i = 0; i < 3; ++i) {
            ...
            tempRelic = i != 2 ? AbstractDungeon.returnRandomRelicEnd(ShopScreen.rollRelicTier()) : AbstractDungeon.returnRandomRelicEnd(AbstractRelic.RelicTier.SHOP);
    ...
    private void updateControllerInput() {
        ...
        if (type == null) {
            if (!this.coloredCards.isEmpty()) {
                Gdx.input.setCursorPosition((int)this.coloredCards.get((int)0).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)0).hb.cY);
            } else if (!this.colorlessCards.isEmpty()) {
                Gdx.input.setCursorPosition((int)this.colorlessCards.get((int)0).hb.cX, Settings.HEIGHT - (int)this.colorlessCards.get((int)0).hb.cY);
            } else if (!this.relics.isEmpty()) {
                Gdx.input.setCursorPosition((int)this.relics.get((int)0).relic.hb.cX, Settings.HEIGHT - (int)this.relics.get((int)0).relic.hb.cY);
            } else if (!this.potions.isEmpty()) {
                Gdx.input.setCursorPosition((int)this.potions.get((int)0).potion.hb.cX, Settings.HEIGHT - (int)this.potions.get((int)0).potion.hb.cY);
            ...
            switch (type) {
                case COLOR_CARD: {
                    if (CInputActionSet.left.isJustPressed() || CInputActionSet.altLeft.isJustPressed()) {
                        ...
                        Gdx.input.setCursorPosition((int)this.coloredCards.get((int)index).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)index).hb.cY);
                        break;
                    }
                    ...
                    if (this.coloredCards.get((int)index).hb.cX < 550.0f * Settings.scale && !this.colorlessCards.isEmpty()) {
                        Gdx.input.setCursorPosition((int)this.colorlessCards.get((int)0).hb.cX, Settings.HEIGHT - (int)this.colorlessCards.get((int)0).hb.cY);
                        return;
                    }
                    if (this.coloredCards.get((int)index).hb.cX < 850.0f * Settings.scale) {
                        if (!this.colorlessCards.isEmpty()) {
                            if (this.colorlessCards.size() > 1) {
                                Gdx.input.setCursorPosition((int)this.colorlessCards.get((int)1).hb.cX, Settings.HEIGHT - (int)this.colorlessCards.get((int)1).hb.cY);
                            } else {
                                Gdx.input.setCursorPosition((int)this.colorlessCards.get((int)0).hb.cX, Settings.HEIGHT - (int)this.colorlessCards.get((int)0).hb.cY);
                            }
                            return;
                    ...
                    if (this.coloredCards.get((int)index).hb.cX < 1400.0f * Settings.scale) {
                        if (!this.relics.isEmpty()) {
                            Gdx.input.setCursorPosition((int)this.relics.get((int)0).relic.hb.cX, Settings.HEIGHT - (int)this.relics.get((int)0).relic.hb.cY);
                            return;
                        }
                ...
                case COLORLESS_CARD: {
                    if (CInputActionSet.left.isJustPressed() || CInputActionSet.altLeft.isJustPressed()) {
                        ...
                        Gdx.input.setCursorPosition((int)this.colorlessCards.get((int)index).hb.cX, Settings.HEIGHT - (int)this.colorlessCards.get((int)index).hb.cY);
                        break;
                    }
                    if (CInputActionSet.right.isJustPressed() || CInputActionSet.altRight.isJustPressed()) {
                    ...
                    if (!CInputActionSet.up.isJustPressed() && !CInputActionSet.altUp.isJustPressed() || this.coloredCards.isEmpty()) break;
                    if (this.colorlessCards.get((int)index).hb.cX < 550.0f * Settings.scale) {
                        Gdx.input.setCursorPosition((int)this.coloredCards.get((int)0).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)0).hb.cY);
                        break;
                    }
                    if (this.coloredCards.size() > 1) {
                        Gdx.input.setCursorPosition((int)this.coloredCards.get((int)1).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)1).hb.cY);
                        break;
                    }
                    Gdx.input.setCursorPosition((int)this.coloredCards.get((int)0).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)0).hb.cY);
                    break;
                ...
                case RELIC: {
                    if (CInputActionSet.left.isJustPressed() || CInputActionSet.altLeft.isJustPressed()) {
                        if (--index < 0 && !this.colorlessCards.isEmpty()) {
                            Gdx.input.setCursorPosition((int)this.colorlessCards.get((int)(this.colorlessCards.size() - 1)).hb.cX, Settings.HEIGHT - (int)this.colorlessCards.get((int)(this.colorlessCards.size() - 1)).hb.cY);
                            break;
                        }
                        if (index < 0) {
                            index = 0;
                        }
                        Gdx.input.setCursorPosition((int)this.relics.get((int)index).relic.hb.cX, Settings.HEIGHT - (int)this.relics.get((int)index).relic.hb.cY);
                        break;
                    }
                    if (CInputActionSet.right.isJustPressed() || CInputActionSet.altRight.isJustPressed()) {
                        ...
                        if (index > this.relics.size() - 1) break;
                        Gdx.input.setCursorPosition((int)this.relics.get((int)index).relic.hb.cX, Settings.HEIGHT - (int)this.relics.get((int)index).relic.hb.cY);
                        break;
                    }
                    if ((CInputActionSet.down.isJustPressed() || CInputActionSet.altDown.isJustPressed()) && !this.potions.isEmpty()) {
                        if (this.potions.size() - 1 >= index) {
                            Gdx.input.setCursorPosition((int)this.potions.get((int)index).potion.hb.cX, Settings.HEIGHT - (int)this.potions.get((int)index).potion.hb.cY);
                            break;
                        }
                        Gdx.input.setCursorPosition((int)this.potions.get((int)0).potion.hb.cX, Settings.HEIGHT - (int)this.potions.get((int)0).potion.hb.cY);
                        break;
                    ...
                    if (this.coloredCards.size() > 3) {
                        Gdx.input.setCursorPosition((int)this.coloredCards.get((int)2).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)2).hb.cY);
                        break;
                    }
                    Gdx.input.setCursorPosition((int)this.coloredCards.get((int)0).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)0).hb.cY);
                    break;
                ...
                case POTION: {
                    ...
                    if (CInputActionSet.right.isJustPressed() || CInputActionSet.altRight.isJustPressed()) {
                        ...
                        if (index > this.potions.size() - 1) break;
                        Gdx.input.setCursorPosition((int)this.potions.get((int)index).potion.hb.cX, Settings.HEIGHT - (int)this.potions.get((int)index).potion.hb.cY);
                        break;
                    }
                    ...
                    if (this.coloredCards.isEmpty()) break;
                    if (this.coloredCards.size() > 3) {
                        Gdx.input.setCursorPosition((int)this.coloredCards.get((int)2).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)2).hb.cY);
                        break;
                    }
                ...
                case PURGE: {
                    if (CInputActionSet.left.isJustPressed() || CInputActionSet.altLeft.isJustPressed()) {
                        if (!this.relics.isEmpty()) {
                            Gdx.input.setCursorPosition((int)this.relics.get((int)(this.relics.size() - 1)).relic.hb.cX, Settings.HEIGHT - (int)this.relics.get((int)(this.relics.size() - 1)).relic.hb.cY);
                            break;
                        }
                        if (!this.potions.isEmpty()) {
                            Gdx.input.setCursorPosition((int)this.potions.get((int)(this.potions.size() - 1)).potion.hb.cX, Settings.HEIGHT - (int)this.potions.get((int)(this.potions.size() - 1)).potion.hb.cY);
                            break;
                        }
                        if (!this.colorlessCards.isEmpty()) break;
                        Gdx.input.setCursorPosition((int)this.colorlessCards.get((int)(this.colorlessCards.size() - 1)).hb.cX, Settings.HEIGHT - (int)this.colorlessCards.get((int)(this.colorlessCards.size() - 1)).hb.cY);
                        break;
                    }
                    if (!CInputActionSet.up.isJustPressed() && !CInputActionSet.altUp.isJustPressed() || this.coloredCards.isEmpty()) break;
                    Gdx.input.setCursorPosition((int)this.coloredCards.get((int)(this.coloredCards.size() - 1)).hb.cX, Settings.HEIGHT - (int)this.coloredCards.get((int)(this.coloredCards.size() - 1)).hb.cY);
                    break;
                }
            }
        }
