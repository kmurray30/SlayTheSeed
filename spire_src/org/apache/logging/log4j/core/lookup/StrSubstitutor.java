        ...
        block0: while (pos < bufEnd) {
            ...
            while (pos < bufEnd) {
                ...
                if (nestedVarCount == 0) {
                    ...
                    String string = varValue = (isCyclic = this.isCyclicSubstitution(varName, priorVariables)) ? null : this.resolveVariable(event, varName, buf, startPos, endPos);
                    if (varValue == null) {
                    ...
                    if (varValue != null) {
                        ...
                        altered = true;
                        int change = this.isRecursiveEvaluationAllowed() ? this.substitute(event, buf, startPos, varLen, priorVariables) : 0;
