...
public class Snecko extends AbstractMonster {
   ...
   protected void getMove(int num) {
      if (this.firstTurn) {
         ...
         this.setMove(MOVES[1], (byte)3, AbstractMonster.Intent.ATTACK_DEBUFF, this.damage.get(1).base);
      } else {
         if (this.lastTwoMoves((byte)2)) {
            this.setMove(MOVES[1], (byte)3, AbstractMonster.Intent.ATTACK_DEBUFF, this.damage.get(1).base);
         } else {
            this.setMove(MOVES[2], (byte)2, AbstractMonster.Intent.ATTACK, this.damage.get(0).base);
         }
      }
   }
