   ...
   public void takeTurn() {
      switch (this.nextMove) {
         ...
         case 5:
            AbstractDungeon.actionManager.addToBottom(new AnimateSlowAttackAction(this));
            AbstractDungeon.actionManager
               .addToBottom(new DamageAction(AbstractDungeon.player, this.damage.get(2), AbstractGameAction.AttackEffect.SLASH_HORIZONTAL));
            AbstractDungeon.actionManager
               .addToBottom(new DamageAction(AbstractDungeon.player, this.damage.get(2), AbstractGameAction.AttackEffect.SLASH_VERTICAL));
      }
   ...
   protected void getMove(int num) {
      if (AbstractDungeon.ascensionLevel >= 17) {
         if (!this.usedHex) {
            ...
            if (num < 50) {
               this.setMove((byte)3, AbstractMonster.Intent.ATTACK_DEBUFF, this.damage.get(1).base);
            } else {
            ...
            this.setMove((byte)5, AbstractMonster.Intent.ATTACK, this.damage.get(2).base, 2, true);
         }
