...
final class LWJGLMouse extends Mouse {
   ...
   private static Component[] createComponents() {
      return new Component[]{
         new LWJGLMouse.Axis(Component.Identifier.Axis.X),
         new LWJGLMouse.Axis(Component.Identifier.Axis.Y),
         new LWJGLMouse.Axis(Component.Identifier.Axis.Z),
         new LWJGLMouse.Button(Component.Identifier.Button.LEFT),
         new LWJGLMouse.Button(Component.Identifier.Button.MIDDLE),
         new LWJGLMouse.Button(Component.Identifier.Button.RIGHT)
      };
   }
