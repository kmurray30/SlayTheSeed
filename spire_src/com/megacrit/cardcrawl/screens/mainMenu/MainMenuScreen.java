...
public class MainMenuScreen {
   ...
   private Hitbox nameEditHb = Settings.isMobile
      ? new Hitbox(550.0F * Settings.scale, 180.0F * Settings.scale)
   ...
   public MainMenuScreen.CurScreen screen = MainMenuScreen.CurScreen.MAIN_MENU;
   ...
   private void updateCharSelectController() {
      if (Settings.isControllerMode && !this.isFadingOut) {
         ...
         if (!anyHovered) {
            int var5 = 0;
            CInputHelper.setCursor(this.charSelectScreen.options.get(var5).hb);
            this.charSelectScreen.options.get(var5).hb.clicked = true;
         } else {
      ...
      if (Settings.isControllerMode) {
         ...
         if (anyHovered) {
            if (CInputActionSet.left.isJustPressed() || CInputActionSet.altLeft.isJustPressed()) {
               ...
               if (this.panelScreen.panels.get(index).pColor == MainMenuPanelButton.PanelColor.GRAY) {
                  index--;
               }
            ...
            int var7 = 0;
            CInputHelper.setCursor(this.panelScreen.panels.get(var7).hb);
         }
      }
   }
   ...
   private void updateRenameArea() {
      ...
      if (this.bg.slider <= 0.1F
         && CardCrawlGame.saveSlotPref.getInteger("DEFAULT_SLOT", -1) == -1
         && this.screen == MainMenuScreen.CurScreen.MAIN_MENU
         && !this.setDefaultSlot()) {
   ...
   public void render(SpriteBatch sb) {
      ...
      if (CardCrawlGame.displayVersion) {
         FontHelper.renderSmartText(
            ...
            VERSION_INFO,
            20.0F * Settings.scale - 700.0F * this.bg.slider,
   ...
   private void renderNameEdit(SpriteBatch sb) {
      if (Settings.isMobile) {
         if (!this.nameEditHb.hovered) {
            FontHelper.renderSmartText(
               ...
               140.0F * Settings.scale - 500.0F * this.bg.slider,
               Settings.HEIGHT - 30.0F * Settings.scale,
               1000.0F,
               30.0F * Settings.scale,
               Color.GOLD,
               0.9F
         ...
         FontHelper.renderSmartText(
            ...
            CardCrawlGame.playerName,
            100.0F * Settings.scale - 500.0F * this.bg.slider,
      ...
      if (!Settings.isTouchScreen && !Settings.isMobile) {
         if (!Settings.isControllerMode) {
            FontHelper.renderSmartText(
               ...
               TEXT[3],
               100.0F * Settings.scale - 500.0F * this.bg.slider,
               Settings.HEIGHT - 60.0F * Settings.scale,
               1000.0F,
               30.0F * Settings.scale,
               Color.SKY,
               1.0F
            ...
            sb.draw(
               ...
               -32.0F + 120.0F * Settings.scale - 500.0F * this.bg.slider,
               -32.0F + Settings.HEIGHT - 78.0F * Settings.scale,
               32.0F,
               32.0F,
               64.0F,
               64.0F,
            ...
            FontHelper.renderSmartText(
               ...
               FontHelper.cardDescFont_N,
               TEXT[4],
               150.0F * Settings.scale - 500.0F * this.bg.slider,
      ...
      if (Settings.isMobile) {
         sb.draw(
            CardCrawlGame.getSaveSlotImg(),
            70.0F * Settings.scale - 50.0F - 500.0F * this.bg.slider,
            Settings.HEIGHT - 70.0F * Settings.scale - 50.0F,
            50.0F,
            50.0F,
            100.0F,
            100.0F,
         ...
         sb.draw(
            CardCrawlGame.getSaveSlotImg(),
            50.0F * Settings.scale - 50.0F - 500.0F * this.bg.slider,
            Settings.HEIGHT - 50.0F * Settings.scale - 50.0F,
            50.0F,
            50.0F,
            100.0F,
            100.0F,
   ...
   private void fadeOut() {
      if (this.isFadingOut && !this.fadedOut) {
         this.overlayColor.a = this.overlayColor.a + Gdx.graphics.getDeltaTime();
         ...
         this.overlayColor.a = this.overlayColor.a - Gdx.graphics.getDeltaTime() * 2.0F;
