...
public class TheCityScene extends AbstractScene {
   ...
   private TheCityScene.PillarConfig pillarConfig = TheCityScene.PillarConfig.OPEN;
   ...
   private void updateParticles() {
      if (!Settings.DISABLE_EFFECTS) {
         this.ceilingDustTimer = this.ceilingDustTimer - Gdx.graphics.getDeltaTime();
   ...
   public void randomizeScene() {
      ...
      if (this.renderWall) {
         int roll = MathUtils.random(2);
         if (roll == 0) {
            this.pillarConfig = TheCityScene.PillarConfig.OPEN;
         } else if (roll == 1) {
            this.pillarConfig = TheCityScene.PillarConfig.LEFT_1;
         } else {
            this.pillarConfig = TheCityScene.PillarConfig.LEFT_2;
         }
      } else {
         int roll = MathUtils.random(2);
         if (roll == 0) {
            ...
            this.pillarConfig = TheCityScene.PillarConfig.SIDES_ONLY;
         } else {
            this.pillarConfig = TheCityScene.PillarConfig.FULL;
         }
      }
