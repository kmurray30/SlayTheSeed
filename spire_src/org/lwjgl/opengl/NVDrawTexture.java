...
public final class NVDrawTexture {
   ...
   static native void nglDrawTextureNV(
      int var0, int var1, float var2, float var3, float var4, float var5, float var6, float var7, float var8, float var9, float var10, long var11
   );
}
