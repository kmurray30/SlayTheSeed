...
public class ParticleShader extends BaseShader {
   ...
   public static String createPrefix(Renderable renderable, ParticleShader.Config config) {
      String prefix = "";
      ...
      if (config.type == ParticleShader.ParticleType.Billboard) {
         prefix = prefix + "#define billboard\n";
         if (config.align == ParticleShader.AlignMode.Screen) {
            prefix = prefix + "#define screenFacing\n";
         } else if (config.align == ParticleShader.AlignMode.ViewPoint) {
   ...
   public boolean canRender(Renderable renderable) {
      return this.materialMask == (renderable.material.getMask() | optionalAttributes)
         && this.vertexMask == renderable.meshPart.mesh.getVertexAttributes().getMask();
   }
