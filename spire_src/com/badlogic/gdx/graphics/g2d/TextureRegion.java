...
public class TextureRegion {
   ...
   public void setRegionX(int x) {
      this.setU((float)x / this.texture.getWidth());
   }
   ...
   public void setRegionY(int y) {
      this.setV((float)y / this.texture.getHeight());
   }
   ...
   public void setRegionWidth(int width) {
      if (this.isFlipX()) {
         this.setU(this.u2 + (float)width / this.texture.getWidth());
      } else {
         this.setU2(this.u + (float)width / this.texture.getWidth());
      }
   }
   ...
   public void setRegionHeight(int height) {
      if (this.isFlipY()) {
         this.setV(this.v2 + (float)height / this.texture.getHeight());
      } else {
         this.setV2(this.v + (float)height / this.texture.getHeight());
      }
   }
