      ...
      this.addMouseListener(new MouseAdapter() {
         ...
         public void mouseClicked(MouseEvent event) {
            ...
            for (TextureRegion region : TexturePanel.this.unselectedRegions) {
               if (TexturePanel.this.isInsideRegion(region, x, y)) {
                  TexturePanel.this.select(region);
                  return;
               }
            }

            for (TextureRegion regionx : TexturePanel.this.selectedRegions) {
               if (TexturePanel.this.isInsideRegion(regionx, x, y)) {
                  TexturePanel.this.unselect(regionx);
                  return;
               }
            }
         }
