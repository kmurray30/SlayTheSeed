      ...
      if (this.card == null) {
         ...
         if (this.randomTarget) {
            AbstractDungeon.actionManager
               .addCardQueueItem(new CardQueueItem(this.card, true, EnergyPanel.getCurrentEnergy(), false, this.autoplayCard), this.immediateCard);
         } else {
            ...
            AbstractDungeon.actionManager
               .addCardQueueItem(
                  new CardQueueItem(this.card, (AbstractMonster)this.target, EnergyPanel.getCurrentEnergy(), false, this.autoplayCard), this.immediateCard
               );
         }
      }
