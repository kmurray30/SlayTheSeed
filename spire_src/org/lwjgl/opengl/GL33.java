...
public final class GL33 {
   ...
   public static int glGetFragDataIndex(int program, ByteBuffer name) {
      ...
      BufferChecks.checkDirect(name);
      BufferChecks.checkNullTerminated(name);
      return nglGetFragDataIndex(program, MemoryUtil.getAddress(name), function_pointer);
   }
   ...
   public static int glGetFragDataIndex(int program, CharSequence name) {
      ...
      long function_pointer = caps.glGetFragDataIndex;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetFragDataIndex(program, APIUtil.getBufferNT(caps, name), function_pointer);
   }
   ...
   public static boolean glIsSampler(int sampler) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsSampler(sampler, function_pointer);
   }
