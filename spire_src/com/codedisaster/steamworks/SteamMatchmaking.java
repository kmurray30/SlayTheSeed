...
public class SteamMatchmaking extends SteamInterface {
   ...
   public SteamAPICall createLobby(SteamMatchmaking.LobbyType lobbyType, int maxMembers) {
      return new SteamAPICall(SteamMatchmakingNative.createLobby(this.callback, lobbyType.ordinal(), maxMembers));
   }

   public SteamAPICall joinLobby(SteamID steamIDLobby) {
      return new SteamAPICall(SteamMatchmakingNative.joinLobby(this.callback, steamIDLobby.handle));
   }
   ...
   public int getLobbyChatEntry(SteamID steamIDLobby, int chatID, SteamMatchmaking.ChatEntry chatEntry, ByteBuffer dest) throws SteamException {
      if (!dest.isDirect()) {
         ...
         return SteamMatchmakingNative.getLobbyChatEntry(steamIDLobby.handle, chatID, chatEntry, dest, dest.position(), dest.remaining());
      }
   }
   ...
   public static class ChatEntry {
      ...
      public SteamMatchmaking.ChatEntryType getChatEntryType() {
         return SteamMatchmaking.ChatEntryType.byValue(this.chatEntryType);
      }
   }
   ...
   public static enum ChatEntryType {
      ...
      static SteamMatchmaking.ChatEntryType byValue(int code) {
   ...
   public static enum ChatRoomEnterResponse {
      ...
      static SteamMatchmaking.ChatRoomEnterResponse byValue(int code) {
