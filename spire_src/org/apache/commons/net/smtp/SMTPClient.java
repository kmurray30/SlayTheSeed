...
public class SMTPClient extends SMTP {
   ...
   public boolean login() throws IOException {
      ...
      return name == null ? false : SMTPReply.isPositiveCompletion(this.helo(name));
   }
   ...
   public boolean sendSimpleMessage(String sender, String recipient, String message) throws IOException {
      if (!this.setSender(sender)) {
         ...
         return !this.addRecipient(recipient) ? false : this.sendShortMessageData(message);
      }
   }
   ...
   public boolean sendSimpleMessage(String sender, String[] recipients, String message) throws IOException {
      ...
      if (!this.setSender(sender)) {
         ...
         return !oneSuccess ? false : this.sendShortMessageData(message);
      }
   }
   ...
   public String listHelp(String command) throws IOException {
      return SMTPReply.isPositiveCompletion(this.help(command)) ? this.getReplyString() : null;
   }
