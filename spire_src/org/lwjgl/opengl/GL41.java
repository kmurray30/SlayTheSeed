...
public final class GL41 {
   ...
   public static void glGetProgramBinary(int program, IntBuffer length, IntBuffer binaryFormat, ByteBuffer binary) {
      ...
      BufferChecks.checkDirect(binary);
      nglGetProgramBinary(
         program, binary.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(binaryFormat), MemoryUtil.getAddress(binary), function_pointer
      );
   }
   ...
   public static int glCreateShaderProgram(int type, ByteBuffer string) {
      ...
      return nglCreateShaderProgramv(type, 1, MemoryUtil.getAddress(string), function_pointer);
   }
   ...
   public static int glCreateShaderProgram(int type, int count, ByteBuffer strings) {
      ...
      return nglCreateShaderProgramv2(type, count, MemoryUtil.getAddress(strings), function_pointer);
   }
   ...
   public static int glCreateShaderProgram(int type, ByteBuffer[] strings) {
      ...
      return nglCreateShaderProgramv3(type, strings.length, strings, function_pointer);
   }
   ...
   public static int glCreateShaderProgram(int type, CharSequence string) {
      ...
      long function_pointer = caps.glCreateShaderProgramv;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglCreateShaderProgramv(type, 1, APIUtil.getBufferNT(caps, string), function_pointer);
   }
   ...
   public static int glCreateShaderProgram(int type, CharSequence[] strings) {
      ...
      return nglCreateShaderProgramv2(type, strings.length, APIUtil.getBufferNT(caps, strings), function_pointer);
   }
   ...
   public static boolean glIsProgramPipeline(int pipeline) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsProgramPipeline(pipeline, function_pointer);
   }
