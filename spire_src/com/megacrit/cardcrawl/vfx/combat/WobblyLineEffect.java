...
extends AbstractGameEffect {
    ...
    public void render(SpriteBatch sb) {
        ...
        sb.draw(this.img, this.x, this.y, (float)this.img.packedWidth / 2.0f, (float)this.img.packedHeight / 2.0f, this.img.packedWidth, this.img.packedHeight, this.scale + MathUtils.random(-0.08f, 0.08f) * Settings.scale, this.scale + MathUtils.random(-0.08f, 0.08f) * Settings.scale, this.rotation + this.flipper + MathUtils.random(-5.0f, 5.0f));
