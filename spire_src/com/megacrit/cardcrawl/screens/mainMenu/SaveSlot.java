...
public class SaveSlot {
   ...
   public SaveSlot(int slot) {
      if (slot == CardCrawlGame.saveSlot
         && !CardCrawlGame.playerName.equals(CardCrawlGame.saveSlotPref.getString(SaveHelper.slotName("PROFILE_NAME", slot), ""))) {
      ...
      this.slotHb.move(Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F + 280.0F * Settings.scale - this.index * 280.0F * Settings.scale);
   ...
   private void renderText(SpriteBatch sb) {
      ...
      if (!this.emptySlot) {
         ...
         FontHelper.renderFontLeft(
            ...
            TEXT[0] + CharStat.formatHMSM((int)this.playtime),
            740.0F * Settings.xScale,
            this.slotHb.cY - 24.0F * Settings.scale,
            uiColor
         );
         if (this.completionPercentage == 100.0F) {
            ...
            FontHelper.renderFontCentered(
               ...
               String.format("%.1f", this.completionPercentage) + "%",
               1200.0F * Settings.xScale,
               this.slotHb.cY + 0.0F * Settings.scale,
               c
            );
         }
      } else {
         FontHelper.renderFontCentered(sb, FontHelper.buttonLabelFont, TEXT[1], Settings.WIDTH / 2.0F, this.slotHb.cY, c);
      }
   }
   ...
   private void renderSlotImage(SpriteBatch sb) {
      ...
      sb.draw(
         ...
         this.slotHb.cX - 400.0F,
         this.slotHb.cY - 130.0F,
         400.0F,
         130.0F,
         800.0F,
         260.0F,
      ...
      sb.draw(
         this.iconImg,
         this.slotHb.cX - 290.0F * Settings.xScale - 50.0F,
         this.slotHb.cY - 50.0F,
         50.0F,
         50.0F,
         100.0F,
         100.0F,
   ...
   private void renderDeleteIcon(SpriteBatch sb) {
      ...
      sb.draw(
         ImageMaster.PROFILE_DELETE,
         this.deleteHb.cX - 50.0F,
         this.deleteHb.cY - 50.0F,
         50.0F,
         50.0F,
         100.0F,
         100.0F,
      ...
      if (this.slotHb.hovered && Settings.isControllerMode) {
         sb.draw(
            ...
            this.deleteHb.cX - 32.0F + 82.0F * Settings.scale,
            this.deleteHb.cY - 32.0F,
            32.0F,
            32.0F,
            64.0F,
            64.0F,
   ...
   private void renderRenameIcon(SpriteBatch sb) {
      ...
      sb.draw(
         ImageMaster.PROFILE_RENAME,
         this.renameHb.cX - 50.0F,
         this.renameHb.cY - 50.0F,
         50.0F,
         50.0F,
         100.0F,
         100.0F,
      ...
      if (this.slotHb.hovered && Settings.isControllerMode) {
         sb.draw(
            ...
            this.renameHb.cX - 32.0F + 82.0F * Settings.scale,
            this.renameHb.cY - 32.0F,
            32.0F,
            32.0F,
            64.0F,
            64.0F,
