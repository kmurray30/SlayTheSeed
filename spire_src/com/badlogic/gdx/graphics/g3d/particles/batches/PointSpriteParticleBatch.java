...
public class PointSpriteParticleBatch extends BufferedParticleBatch<PointSpriteControllerRenderData> {
   ...
   protected static final VertexAttributes CPU_ATTRIBUTES = new VertexAttributes(
      ...
      new VertexAttribute(16, 4, "a_region"),
      new VertexAttribute(512, 3, "a_sizeAndRotation")
   );
   ...
   protected void allocRenderable() {
      ...
      this.renderable.material = new Material(
         new BlendingAttribute(1, 771, 1.0F), new DepthTestAttribute(515, false), TextureAttribute.createDiffuse((Texture)null)
      );
   }
   ...
   protected void flush(int[] offsets) {
      ...
      for (PointSpriteControllerRenderData data : this.renderData) {
         ...
         for (int p = 0; p < data.controller.particles.size; tp++) {
            ...
            this.vertices[offset + CPU_COLOR_OFFSET] = colorChannel.data[colorOffset + 0];
            ...
            this.vertices[offset + CPU_SIZE_AND_ROTATION_OFFSET + 1] = rotationChannel.data[rotationOffset + 0];
            this.vertices[offset + CPU_SIZE_AND_ROTATION_OFFSET + 2] = rotationChannel.data[rotationOffset + 1];
            this.vertices[offset + CPU_REGION_OFFSET] = regionChannel.data[regionOffset + 0];
