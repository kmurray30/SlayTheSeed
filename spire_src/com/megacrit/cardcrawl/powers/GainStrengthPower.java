...
public class GainStrengthPower
extends AbstractPower {
    ...
    public static final String NAME = GainStrengthPower.powerStrings.NAME;
    public static final String[] DESCRIPTIONS = GainStrengthPower.powerStrings.DESCRIPTIONS;
