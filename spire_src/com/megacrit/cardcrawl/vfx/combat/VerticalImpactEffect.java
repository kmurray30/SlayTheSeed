...
public class VerticalImpactEffect extends AbstractGameEffect {
   ...
   public void render(SpriteBatch sb) {
      ...
      sb.draw(
         this.img,
         this.x + MathUtils.random(-10.0F, 10.0F) * Settings.scale,
         this.y,
      ...
      sb.draw(
         ...
         this.scale * 0.3F,
         this.scale * 0.8F,
         this.rotation + MathUtils.random(12.0F, 18.0F)
      );
      sb.draw(
         this.img,
         this.x + MathUtils.random(-10.0F, 10.0F) * Settings.scale,
         ...
         this.scale * 0.4F,
         this.scale * 0.5F,
         this.rotation - MathUtils.random(-10.0F, 14.0F)
      );
      sb.draw(
         this.img,
         this.x + MathUtils.random(-10.0F, 10.0F) * Settings.scale,
         ...
         this.scale * 0.7F,
         this.scale * 0.9F,
         this.rotation + MathUtils.random(20.0F, 28.0F)
      );
      sb.draw(
         this.img,
         this.x + MathUtils.random(-10.0F, 10.0F) * Settings.scale,
         ...
         this.img.packedHeight,
         this.scale * 1.5F,
         this.scale * MathUtils.random(1.4F, 1.6F),
         this.rotation
      );
      ...
      sb.draw(
         ...
         this.img.packedHeight,
         this.scale,
         this.scale * MathUtils.random(0.4F, 0.6F),
         this.rotation
      );
      sb.draw(
         this.img,
