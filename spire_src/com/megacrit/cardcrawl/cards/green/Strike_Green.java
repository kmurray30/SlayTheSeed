...
extends AbstractCard {
    ...
    public Strike_Green() {
        super(ID, Strike_Green.cardStrings.NAME, "green/attack/strike", 1, Strike_Green.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.GREEN, AbstractCard.CardRarity.BASIC, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 6;
