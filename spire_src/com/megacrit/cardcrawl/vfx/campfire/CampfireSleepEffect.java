...
extends AbstractGameEffect {
    ...
    public static final String[] TEXT = CampfireSleepEffect.uiStrings.TEXT;
    ...
    public CampfireSleepEffect() {
        this.startingDuration = Settings.FAST_MODE ? 1.5f : 3.0f;
    ...
    private void updateBlackScreenColor() {
        this.screenColor.a = this.duration > this.startingDuration - 0.5f ? Interpolation.fade.apply(1.0f, 0.0f, (this.duration - (this.startingDuration - 0.5f)) * 2.0f) : (this.duration < 1.0f ? Interpolation.fade.apply(0.0f, 1.0f, this.duration) : 1.0f);
    }
