...
public class CursedTome extends AbstractImageEvent {
   ...
   private CursedTome.CurScreen screen = CursedTome.CurScreen.INTRO;
      ...
      switch (this.screen) {
         case INTRO:
            ...
            if (buttonPressed == 0) {
               ...
               this.screen = CursedTome.CurScreen.PAGE_1;
            } else {
               this.imageEventText.clearAllDialogs();
               this.imageEventText.setDialogOption(OPT_LEAVE);
               this.imageEventText.updateBodyText(IGNORE_MSG);
               this.screen = CursedTome.CurScreen.END;
         ...
         case PAGE_1:
            ...
            this.screen = CursedTome.CurScreen.PAGE_2;
            break;
         case PAGE_2:
            CardCrawlGame.sound.play("EVENT_TOME");
            ...
            this.screen = CursedTome.CurScreen.PAGE_3;
            break;
         case PAGE_3:
            CardCrawlGame.sound.play("EVENT_TOME");
