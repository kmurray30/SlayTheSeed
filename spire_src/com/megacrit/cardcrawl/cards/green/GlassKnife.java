...
extends AbstractCard {
    ...
    public GlassKnife() {
        super(ID, GlassKnife.cardStrings.NAME, "green/attack/glass_knife", 1, GlassKnife.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.GREEN, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 8;
    }
