      ...
      if (matcher.matches() && !"T".equals(matcher.group(2))) {
         ...
         if (dayMatch != null || hourMatch != null || minuteMatch != null || secondMatch != null) {
            ...
            try {
               ...
               throw new IllegalArgumentException("Text cannot be parsed to a Duration (overflow) " + text, var15);
            }
         }
      }
   ...
   private static long parseNumber(final CharSequence text, final String parsed, final int multiplier, final String errorText) {
      if (parsed == null) {
         ...
         try {
            ...
            throw new IllegalArgumentException("Text cannot be parsed to a Duration: " + errorText + " (in " + text + ")", var6);
         }
      }
   }
