...
public final class ARBSparseTexture {
   ...
   public static void glTexturePageCommitmentEXT(
      int texture, int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, boolean commit
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
   ...
   static native void nglTexturePageCommitmentEXT(
      int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, boolean var9, long var10
   );
}
