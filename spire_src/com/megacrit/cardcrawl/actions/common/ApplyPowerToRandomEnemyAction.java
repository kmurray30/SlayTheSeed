...
public class ApplyPowerToRandomEnemyAction extends AbstractGameAction {
   ...
   public ApplyPowerToRandomEnemyAction(
      AbstractCreature source, AbstractPower powerToApply, int stackAmount, boolean isFast, AbstractGameAction.AttackEffect effect
   ) {
