...
extends AbstractCard {
    ...
    public DeceiveReality() {
        super(ID, DeceiveReality.cardStrings.NAME, "purple/skill/deceive_reality", 1, DeceiveReality.cardStrings.DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.PURPLE, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
        this.baseBlock = 4;
