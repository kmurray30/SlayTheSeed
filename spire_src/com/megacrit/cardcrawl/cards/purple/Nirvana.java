...
extends AbstractCard {
    ...
    public Nirvana() {
        super(ID, Nirvana.cardStrings.NAME, "purple/power/nirvana", 1, Nirvana.cardStrings.DESCRIPTION, AbstractCard.CardType.POWER, AbstractCard.CardColor.PURPLE, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
