...
extends AbstractPotion {
    ...
    public SneckoOil() {
        super(SneckoOil.potionStrings.NAME, POTION_ID, AbstractPotion.PotionRarity.RARE, AbstractPotion.PotionSize.SNECKO, AbstractPotion.PotionColor.SNECKO);
        this.isThrown = false;
    }
    ...
    public void initializeData() {
        ...
        this.description = SneckoOil.potionStrings.DESCRIPTIONS[0] + this.potency + SneckoOil.potionStrings.DESCRIPTIONS[1];
        this.tips.clear();
