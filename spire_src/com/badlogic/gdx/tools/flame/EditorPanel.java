...
public abstract class EditorPanel<T> extends JPanel {
   ...
   protected void initializeComponents() {
      ...
      this.titlePanel.add(this.nameLabel, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0, 17, 0, new Insets(3, 6, 3, 6), 0, 0));
      ...
      this.titlePanel.add(this.removeButton, new GridBagConstraints(4, 0, 1, 1, 0.0, 0.0, 10, 0, new Insets(0, 0, 0, 6), 0, 0));
   ...
   protected void addContent(int row, int column, JComponent component, boolean addBorders, int anchor, int fill, float wx, float wy) {
      addContent(this.contentPanel, row, column, component, addBorders, anchor, fill, wx, wy);
   }
