...
public class FlyingSleeves extends AbstractCard {
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      if (m != null) {
         ...
         this.addToBot(
            new VFXAction(new AnimatedSlashEffect(m.hb.cX, m.hb.cY - 30.0F * Settings.scale, 500.0F, 200.0F, 290.0F, 3.0F, Color.VIOLET, Color.PINK))
         );
      }
      ...
      if (m != null) {
         ...
         this.addToBot(new SFXAction("ATTACK_FAST", 0.2F));
         this.addToBot(
            new VFXAction(new AnimatedSlashEffect(m.hb.cX, m.hb.cY - 30.0F * Settings.scale, 500.0F, -200.0F, 250.0F, 3.0F, Color.VIOLET, Color.PINK))
         );
      }
