...
public final class CL11 {
   ...
   public static CLMem clCreateSubBuffer(CLMem buffer, long flags, int buffer_create_type, ByteBuffer buffer_create_info, IntBuffer errcode_ret) {
      ...
      return CLMem.create(
         nclCreateSubBuffer(
            buffer.getPointer(), flags, buffer_create_type, MemoryUtil.getAddress(buffer_create_info), MemoryUtil.getAddressSafe(errcode_ret), function_pointer
         ),
         buffer.getParent()
      );
   }
   ...
   public static int clEnqueueReadBufferRect(
      ...
      int __result = nclEnqueueReadBufferRect(
   ...
   static native int nclEnqueueReadBufferRect(
      long var0,
      long var2,
      int var4,
      long var5,
   ...
   public static int clEnqueueWriteBufferRect(
      ...
      int __result = nclEnqueueWriteBufferRect(
         command_queue.getPointer(),
         buffer.getPointer(),
         blocking_write,
         MemoryUtil.getAddress(buffer_offset),
   ...
   public static int clEnqueueCopyBufferRect(
      ...
      int __result = nclEnqueueCopyBufferRect(
         command_queue.getPointer(),
   ...
   static native int nclEnqueueCopyBufferRect(
      long var0,
      long var2,
      long var4,
      long var6,
   ...
   public static CLEvent clCreateUserEvent(CLContext context, IntBuffer errcode_ret) {
      ...
      return new CLEvent(nclCreateUserEvent(context.getPointer(), MemoryUtil.getAddressSafe(errcode_ret), function_pointer), context);
   }
   ...
   public static int clSetUserEventStatus(CLEvent event, int execution_status) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nclSetUserEventStatus(event.getPointer(), execution_status, function_pointer);
   }
