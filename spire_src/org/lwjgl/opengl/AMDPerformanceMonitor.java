...
public final class AMDPerformanceMonitor {
   ...
   public static void glGetPerfMonitorCountersAMD(int group, IntBuffer numCounters, IntBuffer maxActiveCounters, IntBuffer counters) {
      ...
      nglGetPerfMonitorCountersAMD(
         group,
         MemoryUtil.getAddress(numCounters),
         MemoryUtil.getAddress(maxActiveCounters),
         counters == null ? 0 : counters.remaining(),
         MemoryUtil.getAddressSafe(counters),
         function_pointer
      );
   }
   ...
   public static void glGetPerfMonitorGroupStringAMD(int group, IntBuffer length, ByteBuffer groupString) {
      ...
      nglGetPerfMonitorGroupStringAMD(
         group, groupString == null ? 0 : groupString.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddressSafe(groupString), function_pointer
      );
   }
   ...
   public static String glGetPerfMonitorGroupStringAMD(int group, int bufSize) {
      ...
      ((Buffer)groupString).limit(groupString_length.get(0));
   ...
   public static void glGetPerfMonitorCounterStringAMD(int group, int counter, IntBuffer length, ByteBuffer counterString) {
      ...
      nglGetPerfMonitorCounterStringAMD(
         ...
         MemoryUtil.getAddressSafe(counterString),
         function_pointer
      );
   }
   ...
   public static String glGetPerfMonitorCounterStringAMD(int group, int counter, int bufSize) {
      ...
      nglGetPerfMonitorCounterStringAMD(
         group, counter, bufSize, MemoryUtil.getAddress0(counterString_length), MemoryUtil.getAddress(counterString), function_pointer
      );
      ((Buffer)counterString).limit(counterString_length.get(0));
