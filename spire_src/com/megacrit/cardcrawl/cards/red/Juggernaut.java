...
extends AbstractCard {
    ...
    public Juggernaut() {
        super(ID, Juggernaut.cardStrings.NAME, "red/power/juggernaut", 2, Juggernaut.cardStrings.DESCRIPTION, AbstractCard.CardType.POWER, AbstractCard.CardColor.RED, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.SELF);
