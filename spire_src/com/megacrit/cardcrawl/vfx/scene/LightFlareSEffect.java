...
public class LightFlareSEffect
extends AbstractGameEffect {
    ...
    public LightFlareSEffect(float x, float y) {
        if (imgs[0] == null) {
            LightFlareSEffect.imgs[0] = ImageMaster.vfxAtlas.findRegion("env/lightFlare1");
            LightFlareSEffect.imgs[1] = ImageMaster.vfxAtlas.findRegion("env/lightFlare2");
        }
