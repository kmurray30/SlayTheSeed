...
public class ShadowEffect implements ConfigurableEffect {
   ...
   public void draw(BufferedImage image, Graphics2D g, UnicodeFont unicodeFont, Glyph glyph) {
      ...
      g.translate((double)this.xDistance, (double)this.yDistance);
   ...
   public List getValues() {
      ...
      values.add(
         EffectUtil.optionValue(
            "Blur kernel size",
            String.valueOf(this.blurKernelSize),
            optionsArray,
            "This setting controls how many neighboring pixels are used to blur the shadow. Set to \"None\" for no blur."
         )
      );
      values.add(
         EffectUtil.intValue("Blur passes", this.blurPasses, "The setting is the number of times to apply a blur to the shadow. Set to \"0\" for no blur.")
      );
      return values;
   }
