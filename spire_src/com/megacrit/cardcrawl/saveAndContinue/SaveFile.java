...
public class SaveFile {
    ...
    public SaveFile(SaveType type) {
        ...
        if (AbstractPlayer.customMods == null) {
            AbstractPlayer.customMods = CardCrawlGame.trial != null ? CardCrawlGame.trial.dailyModIDs() : new ArrayList();
        }
        ...
        this.bottled_flame = AbstractDungeon.player.hasRelic("Bottled Flame") ? (((BottledFlame)AbstractDungeon.player.getRelic((String)"Bottled Flame")).card != null ? ((BottledFlame)AbstractDungeon.player.getRelic((String)"Bottled Flame")).card.cardID : null) : null;
        this.bottled_lightning = AbstractDungeon.player.hasRelic("Bottled Lightning") ? (((BottledLightning)AbstractDungeon.player.getRelic((String)"Bottled Lightning")).card != null ? ((BottledLightning)AbstractDungeon.player.getRelic((String)"Bottled Lightning")).card.cardID : null) : null;
        this.bottled_tornado = AbstractDungeon.player.hasRelic("Bottled Tornado") ? (((BottledTornado)AbstractDungeon.player.getRelic((String)"Bottled Tornado")).card != null ? ((BottledTornado)AbstractDungeon.player.getRelic((String)"Bottled Tornado")).card.cardID : null) : null;
