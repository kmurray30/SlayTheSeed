...
public class UnixCrypt {
   private static final int[] CON_SALT = new int[]{
      0,
      0,
      0,
      0,
   ...
   private static final int[] COV2CHAR = new int[]{
      46,
      47,
      48,
      49,
   ...
   private static final int[][] SKB = new int[][]{
      {
            0,
            16,
            536870912,
   ...
   private static final int[][] SPTRANS = new int[][]{
      {
            8520192,
            131072,
            -2139095040,
   ...
   private static int[] body(int[] schedule, int eSwap0, int eSwap1) {
      ...
      int var14 = left >>> 1 | left << 31;
      left = right >>> 1 | right << 31;
      int[] results = new int[2];
      permOp(var14, left, 1, 1431655765, results);
      right = results[0];
      left = results[1];
   ...
   private static int[] desSetKey(byte[] key) {
      ...
      d = results[0];
      c = results[1];
      d = (d & 0xFF) << 16 | d & 0xFF00 | (d & 0xFF0000) >>> 16 | (c & -268435456) >>> 4;
      c &= 268435455;
      int j = 0;
      ...
      for (int i = 0; i < 16; i++) {
         ...
         int s = SKB[0][c & 63]
            | SKB[1][c >>> 6 & 3 | c >>> 7 & 60]
            | SKB[2][c >>> 13 & 15 | c >>> 14 & 48]
            | SKB[3][c >>> 20 & 1 | c >>> 21 & 6 | c >>> 22 & 56];
   ...
   private static int fourBytesToInt(byte[] b, int offset) {
      ...
      return value | byteToUnsigned(b[offset++]) << 24;
   }
