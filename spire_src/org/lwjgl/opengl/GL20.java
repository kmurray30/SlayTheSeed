...
public final class GL20 {
   ...
   public static int glCreateShader(int type) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglCreateShader(type, function_pointer);
   }
   ...
   public static boolean glIsShader(int shader) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsShader(shader, function_pointer);
   }
   ...
   public static int glCreateProgram() {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglCreateProgram(function_pointer);
   }
   ...
   public static boolean glIsProgram(int program) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsProgram(program, function_pointer);
   }
   ...
   public static int glGetUniformLocation(int program, ByteBuffer name) {
      ...
      return nglGetUniformLocation(program, MemoryUtil.getAddress(name), function_pointer);
   }
   ...
   public static int glGetUniformLocation(int program, CharSequence name) {
      ...
      long function_pointer = caps.glGetUniformLocation;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetUniformLocation(program, APIUtil.getBufferNT(caps, name), function_pointer);
   }
   ...
   public static int glGetAttribLocation(int program, ByteBuffer name) {
      ...
      BufferChecks.checkDirect(name);
      BufferChecks.checkNullTerminated(name);
      return nglGetAttribLocation(program, MemoryUtil.getAddress(name), function_pointer);
   }
   ...
   public static int glGetAttribLocation(int program, CharSequence name) {
      ...
      long function_pointer = caps.glGetAttribLocation;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetAttribLocation(program, APIUtil.getBufferNT(caps, name), function_pointer);
   }
