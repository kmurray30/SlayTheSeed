...
public final class GL30 {
   ...
   public static String glGetStringi(int name, int index) {
      ...
      return nglGetStringi(name, index, function_pointer);
   }
   ...
   public static int glGetFragDataLocation(int program, ByteBuffer name) {
      ...
      BufferChecks.checkDirect(name);
      BufferChecks.checkNullTerminated(name);
      return nglGetFragDataLocation(program, MemoryUtil.getAddress(name), function_pointer);
   }
   ...
   public static int glGetFragDataLocation(int program, CharSequence name) {
      ...
      long function_pointer = caps.glGetFragDataLocation;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetFragDataLocation(program, APIUtil.getBufferNT(caps, name), function_pointer);
   }
   ...
   public static boolean glIsRenderbuffer(int renderbuffer) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsRenderbuffer(renderbuffer, function_pointer);
   }
   ...
   public static boolean glIsFramebuffer(int framebuffer) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsFramebuffer(framebuffer, function_pointer);
   }
   ...
   public static int glCheckFramebufferStatus(int target) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglCheckFramebufferStatus(target, function_pointer);
   }
   ...
   public static boolean glIsEnabledi(int target, int index) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsEnabledi(target, index, function_pointer);
   }
   ...
   public static boolean glIsVertexArray(int array) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsVertexArray(array, function_pointer);
   }
