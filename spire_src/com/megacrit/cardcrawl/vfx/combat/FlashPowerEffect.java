...
public class FlashPowerEffect extends AbstractGameEffect {
   ...
   public FlashPowerEffect(AbstractPower power) {
      ...
      if (this.img == null) {
         this.x = this.x - this.region128.packedWidth / 2;
         this.y = this.y - this.region128.packedHeight / 2;
      }
   ...
   public void render(SpriteBatch sb) {
      ...
      if (this.img != null) {
         ...
         sb.draw(
            ...
            this.x,
            this.y,
            this.region128.packedWidth / 2.0F,
            this.region128.packedHeight / 2.0F,
            this.region128.packedWidth,
            this.region128.packedHeight,
            this.scale * 3.0F,
            this.scale * 3.0F,
            0.0F
         );
