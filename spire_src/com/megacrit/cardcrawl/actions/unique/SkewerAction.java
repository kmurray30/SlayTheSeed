    ...
    public void update() {
        ...
        if (effect > 0) {
            for (int i = 0; i < effect; ++i) {
                this.addToBot(new DamageAction((AbstractCreature)this.m, new DamageInfo(this.p, this.damage, this.damageTypeForTurn), AbstractGameAction.AttackEffect.BLUNT_LIGHT));
            }
