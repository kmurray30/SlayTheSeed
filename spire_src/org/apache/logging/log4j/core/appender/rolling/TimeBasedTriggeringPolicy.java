...
public final class TimeBasedTriggeringPolicy extends AbstractTriggeringPolicy {
   ...
   public static class Builder implements org.apache.logging.log4j.core.util.Builder<TimeBasedTriggeringPolicy> {
      ...
      public TimeBasedTriggeringPolicy.Builder withInterval(final int interval) {
         this.interval = interval;
         return this;
      }

      public TimeBasedTriggeringPolicy.Builder withModulate(final boolean modulate) {
         this.modulate = modulate;
         return this;
      }

      public TimeBasedTriggeringPolicy.Builder withMaxRandomDelay(final int maxRandomDelay) {
