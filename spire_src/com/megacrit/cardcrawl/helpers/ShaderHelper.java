...
public class ShaderHelper {
   ...
   public static void initializeShaders() {
      ...
      gsShader = new ShaderProgram(
         Gdx.files.internal("shaders/grayscale/vertexShader.vs").readString(), Gdx.files.internal("shaders/grayscale/fragShader.fs").readString()
      );
   }

   public static void setShader(SpriteBatch sb, ShaderHelper.Shader shader) {
      switch (shader) {
         case BLUR:
            sb.end();
   ...
   public static void setShader(PolygonSpriteBatch sb, ShaderHelper.Shader shader) {
      switch (shader) {
         case BLUR:
            sb.setShader(blurShader);
            break;
