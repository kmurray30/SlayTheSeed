...
public final class NVPresentVideo {
   ...
   public static void glPresentFrameKeyedNV(
      ...
      nglPresentFrameKeyedNV(
         video_slot, minPresentTime, beginPresentTimeId, presentDurationId, type, target0, fill0, key0, target1, fill1, key1, function_pointer
      );
   }

   static native void nglPresentFrameKeyedNV(
      int var0, long var1, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, long var12
   );
   ...
   static native void nglPresentFrameDualFillNV(
      int var0, long var1, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, int var13, long var14
   );
