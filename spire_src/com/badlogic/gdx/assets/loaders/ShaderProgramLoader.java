...
public class ShaderProgramLoader extends AsynchronousAssetLoader<ShaderProgram, ShaderProgramLoader.ShaderProgramParameter> {
   ...
   public void loadAsync(AssetManager manager, String fileName, FileHandle file, ShaderProgramLoader.ShaderProgramParameter parameter) {
   }

   public ShaderProgram loadSync(AssetManager manager, String fileName, FileHandle file, ShaderProgramLoader.ShaderProgramParameter parameter) {
