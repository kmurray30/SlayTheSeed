...
public class Merchant implements Disposable {
   ...
   public Merchant(float x, float y, int newShopScreen) {
      this.anim = new AnimatedNpc(
         DRAW_X + 256.0F * Settings.scale,
      ...
      while (Objects.equals(c.cardID, this.cards1.get(this.cards1.size() - 1).cardID) || c.color == AbstractCard.CardColor.COLORLESS) {
         c = AbstractDungeon.getCardFromPool(AbstractDungeon.rollRarity(), AbstractCard.CardType.ATTACK, true).makeCopy();
      }
   ...
   public void render(SpriteBatch sb) {
      ...
      if (Settings.isControllerMode) {
         ...
         sb.draw(
            ...
            DRAW_X - 32.0F + 150.0F * Settings.scale,
            DRAW_Y - 32.0F + 100.0F * Settings.scale,
            32.0F,
            32.0F,
            64.0F,
            64.0F,
