...
public interface Library {
   ...
   public static class Handler implements InvocationHandler {
      ...
      private final Map<Method, Library.Handler.FunctionInfo> functions = new WeakHashMap<>();
      ...
      public Handler(String libname, Class<?> interfaceClass, Map<String, ?> options) {
         if (libname != null && "".equals(libname.trim())) {
            ...
            this.options = new HashMap<>((Map<? extends String, ? extends Object>)options);
      ...
      public Object invoke(Object proxy, Method method, Object[] inArgs) throws Throwable {
         if (OBJECT_TOSTRING.equals(method)) {
            ...
            Library.Handler.FunctionInfo f = this.functions.get(method);
            if (f == null) {
            ...
            return f.handler != null
               ? f.handler.invoke(proxy, method, inArgs)
               : f.function.invoke(method, f.parameterTypes, method.getReturnType(), inArgs, f.options);
         }
      }
