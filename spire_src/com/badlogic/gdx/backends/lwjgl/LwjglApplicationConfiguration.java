...
public class LwjglApplicationConfiguration {
   ...
   public static Graphics.DisplayMode getDesktopDisplayMode() {
      ...
      return new LwjglApplicationConfiguration.LwjglApplicationConfigurationDisplayMode(
   ...
   public static Graphics.DisplayMode[] getDisplayModes() {
      ...
      for (DisplayMode mode : displayModes) {
         ...
         if (!duplicate && mode.getBitDepth() == desktopMode.getBitDepth()) {
            modes.add(
               new LwjglApplicationConfiguration.LwjglApplicationConfigurationDisplayMode(
                  mode.getWidth(), mode.getHeight(), mode.getRefreshRate(), mode.getBitDepth()
               )
            );
         }
