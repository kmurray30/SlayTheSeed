...
public abstract class AbstractPotion {
   ...
   public final AbstractPotion.PotionEffect p_effect;
   public final AbstractPotion.PotionColor color;
   public Color liquidColor;
   public Color hybridColor;
   public Color spotsColor;
   public AbstractPotion.PotionRarity rarity;
   public AbstractPotion.PotionSize size;
   ...
   public AbstractPotion(
      ...
      AbstractPotion.PotionSize size,
      AbstractPotion.PotionEffect effect,
      Color liquidColor,
      Color hybridColor,
      Color spotsColor
   ) {
   ...
   public AbstractPotion(String name, String id, AbstractPotion.PotionRarity rarity, AbstractPotion.PotionSize size, AbstractPotion.PotionColor color) {
      this.scale = Settings.scale;
      this.isObtained = false;
      this.sparkleTimer = 0.0F;
      this.flashCount = 0;
      ...
      this.name = name;
      this.rarity = rarity;
      this.p_effect = AbstractPotion.PotionEffect.NONE;
      this.initializeImage();
   ...
   public void renderLightOutline(SpriteBatch sb) {
      if (!(this instanceof PotionSlot)) {
         ...
         sb.draw(
            this.outlineImg, this.posX - 32.0F, this.posY - 32.0F, 32.0F, 32.0F, 64.0F, 64.0F, this.scale, this.scale, this.angle, 0, 0, 64, 64, false, false
         );
      }
   }
   ...
   public void renderShiny(SpriteBatch sb) {
      if (!(this instanceof PotionSlot)) {
         ...
         sb.draw(
            this.containerImg, this.posX - 32.0F, this.posY - 32.0F, 32.0F, 32.0F, 64.0F, 64.0F, this.scale, this.scale, this.angle, 0, 0, 64, 64, false, false
         );
   ...
   public void render(SpriteBatch sb) {
      ...
      if (this instanceof PotionSlot) {
         ...
         sb.draw(
            ImageMaster.POTION_PLACEHOLDER,
            this.posX - 32.0F,
            this.posY - 32.0F,
            32.0F,
            32.0F,
         ...
         sb.draw(
            this.liquidImg, this.posX - 32.0F, this.posY - 32.0F, 32.0F, 32.0F, 64.0F, 64.0F, this.scale, this.scale, this.angle, 0, 0, 64, 64, false, false
         );
         if (this.hybridColor != null) {
            sb.setColor(this.hybridColor);
            sb.draw(
               this.hybridImg, this.posX - 32.0F, this.posY - 32.0F, 32.0F, 32.0F, 64.0F, 64.0F, this.scale, this.scale, this.angle, 0, 0, 64, 64, false, false
            );
         }
         ...
         if (this.spotsColor != null) {
            ...
            sb.draw(
               this.spotsImg, this.posX - 32.0F, this.posY - 32.0F, 32.0F, 32.0F, 64.0F, 64.0F, this.scale, this.scale, this.angle, 0, 0, 64, 64, false, false
            );
         }
