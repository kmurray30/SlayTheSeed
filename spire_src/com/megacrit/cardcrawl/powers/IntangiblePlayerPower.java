...
public class IntangiblePlayerPower
extends AbstractPower {
    ...
    public static final String NAME = IntangiblePlayerPower.powerStrings.NAME;
    public static final String[] DESCRIPTIONS = IntangiblePlayerPower.powerStrings.DESCRIPTIONS;
