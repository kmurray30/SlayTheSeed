...
public class TextureUnpacker {
   ...
   private int parseArguments(String[] args) {
      ...
      if (numArgs < 1) {
         ...
         boolean extension = args[0].substring(args[0].length() - ".atlas".length()).equals(".atlas");
   ...
   public void splitAtlas(TextureAtlas.TextureAtlasData atlas, String outputDir) {
      ...
      for (TextureAtlas.TextureAtlasData.Page page : atlas.getPages()) {
         ...
         try {
            ...
            this.printExceptionAndExit(var15);
         }
         ...
         for (TextureAtlas.TextureAtlasData.Region region : atlas.getRegions()) {
            ...
            if (region.page == page) {
               ...
               if (region.splits == null) {
                  ...
                  extension = String.format("9.%s", "png");
               }
               ...
               try {
                  ImageIO.write(splitImage, "png", imgOutput);
               } catch (IOException var14) {
                  this.printExceptionAndExit(var14);
               }
            }
         }
      }
   ...
   public static void main(String[] args) {
      ...
      switch (unpacker.parseArguments(args)) {
         case 0:
            System.out.println("Usage: atlasFile [imageDir] [outputDir]");
            return;
         case 3:
            outputDir = args[2];
         case 2:
         ...
         default:
            ...
            if (outputDir == null) {
               outputDir = new File(atlasParentPath, "output").getAbsolutePath();
            }
