...
public class TouchPickupGold extends AbstractGameEffect {
   ...
   public TouchPickupGold() {
      ...
      this.landingY = MathUtils.random(AbstractDungeon.floorY - Settings.HEIGHT * 0.05F, AbstractDungeon.floorY + Settings.HEIGHT * 0.08F);
   ...
   public void update() {
      if (!this.isPickupable) {
         this.x = this.x + this.vX * Gdx.graphics.getDeltaTime() * 60.0F;
