...
public class LightFlareLEffect
extends AbstractGameEffect {
    ...
    public LightFlareLEffect(float x, float y) {
        if (imgs[0] == null) {
            LightFlareLEffect.imgs[0] = ImageMaster.vfxAtlas.findRegion("env/lightFlare1");
            LightFlareLEffect.imgs[1] = ImageMaster.vfxAtlas.findRegion("env/lightFlare2");
        }
