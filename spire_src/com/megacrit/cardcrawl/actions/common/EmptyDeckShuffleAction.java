...
extends AbstractGameAction {
    ...
    public static final String[] MSG = EmptyDeckShuffleAction.tutorialStrings.TEXT;
    public static final String[] LABEL = EmptyDeckShuffleAction.tutorialStrings.LABEL;
