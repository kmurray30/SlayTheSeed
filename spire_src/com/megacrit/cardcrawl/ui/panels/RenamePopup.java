...
public class RenamePopup {
   ...
   private void renderHeader(SpriteBatch sb) {
      ...
      c.a = this.uiColor.a;
      FontHelper.renderFontCentered(sb, FontHelper.cardTitleFont, TEXT[1], Settings.WIDTH / 2.0F, Settings.OPTION_Y + 150.0F * Settings.scale, c);
   }
   ...
   private void renderTextbox(SpriteBatch sb) {
      sb.draw(
         ...
         Settings.OPTION_Y + 20.0F * Settings.scale - 160.0F,
         160.0F,
         160.0F,
         320.0F,
         320.0F,
      ...
      FontHelper.renderSmartText(
         ...
         Settings.OPTION_Y + 24.0F * Settings.scale,
         100000.0F,
         0.0F,
         this.uiColor,
         0.82F
