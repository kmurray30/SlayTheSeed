...
public final class ARBShadingLanguageInclude {
   ...
   public static boolean glIsNamedStringARB(ByteBuffer name) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(name);
      return nglIsNamedStringARB(name.remaining(), MemoryUtil.getAddress(name), function_pointer);
   }
   ...
   public static boolean glIsNamedStringARB(CharSequence name) {
      ...
      long function_pointer = caps.glIsNamedStringARB;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsNamedStringARB(name.length(), APIUtil.getBuffer(caps, name), function_pointer);
   }
   ...
   public static void glGetNamedStringARB(ByteBuffer name, IntBuffer stringlen, ByteBuffer string) {
      ...
      nglGetNamedStringARB(
         ...
         string.remaining(),
         MemoryUtil.getAddressSafe(stringlen),
         MemoryUtil.getAddress(string),
         function_pointer
      );
   }
   ...
   public static String glGetNamedStringARB(CharSequence name, int bufSize) {
      ...
      nglGetNamedStringARB(
         name.length(), APIUtil.getBuffer(caps, name), bufSize, MemoryUtil.getAddress0(string_length), MemoryUtil.getAddress(string), function_pointer
      );
      ((Buffer)string).limit(name.length() + string_length.get(0));
