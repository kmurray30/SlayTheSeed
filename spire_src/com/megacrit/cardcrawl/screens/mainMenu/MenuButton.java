...
public class MenuButton {
   ...
   public void render(SpriteBatch sb) {
      ...
      if (!Settings.isTouchScreen && !Settings.isMobile) {
         sb.draw(
            highlightImg,
            this.x + FONT_X + sliderX - 179.0F + 120.0F * Settings.scale,
            this.hb.cY - 52.0F,
            179.0F,
            52.0F,
            358.0F,
      ...
      if (!Settings.isTouchScreen && !Settings.isMobile) {
         FontHelper.renderSmartText(
            sb, FontHelper.buttonLabelFont, this.label, this.x + FONT_X + sliderX, this.hb.cY + FONT_OFFSET_Y, 9999.0F, 1.0F, Settings.CREAM_COLOR
         );
      } else {
         FontHelper.renderSmartText(
            sb, FontHelper.losePowerFont, this.label, this.x + FONT_X + sliderX, this.hb.cY + FONT_OFFSET_Y, 9999.0F, 1.0F, Settings.CREAM_COLOR, 1.25F
         );
      }
