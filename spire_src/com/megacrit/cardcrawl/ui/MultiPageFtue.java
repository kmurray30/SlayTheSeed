...
public class MultiPageFtue extends FtueTip {
   ...
   public void update() {
      if (this.screen.a != 0.8F) {
         this.screen.a = this.screen.a + Gdx.graphics.getDeltaTime();
         if (this.screen.a > 0.8F) {
            this.screen.a = 0.8F;
         }
      }
      ...
      if (this.scrollTimer != 0.0F) {
         this.scrollTimer = this.scrollTimer - Gdx.graphics.getDeltaTime();
         if (this.scrollTimer < 0.0F) {
   ...
   public void render(SpriteBatch sb) {
      ...
      sb.draw(
         this.img1,
         this.x + this.x1 - 380.0F,
         Settings.HEIGHT / 2.0F - 290.0F,
         380.0F,
         290.0F,
         760.0F,
         580.0F,
      ...
      FontHelper.renderSmartText(
         ...
         msg1,
         this.x + this.x1 + 400.0F * Settings.scale,
         Settings.HEIGHT / 2.0F - FontHelper.getSmartHeight(FontHelper.panelNameFont, msg1, 700.0F * Settings.scale, 40.0F * Settings.scale) / 2.0F + offsetY,
      ...
      FontHelper.renderSmartText(
         ...
         FontHelper.panelNameFont,
         msg2,
         this.x + this.x2 + 400.0F * Settings.scale,
         Settings.HEIGHT / 2.0F - FontHelper.getSmartHeight(FontHelper.panelNameFont, msg2, 700.0F * Settings.scale, 40.0F * Settings.scale) / 2.0F + offsetY,
         700.0F * Settings.scale,
         40.0F * Settings.scale,
         Settings.CREAM_COLOR
      );
      FontHelper.renderSmartText(
         ...
         FontHelper.panelNameFont,
         msg3,
         this.x + this.x3 + 400.0F * Settings.scale,
         Settings.HEIGHT / 2.0F - FontHelper.getSmartHeight(FontHelper.panelNameFont, msg3, 700.0F * Settings.scale, 40.0F * Settings.scale) / 2.0F + offsetY,
         700.0F * Settings.scale,
         40.0F * Settings.scale,
         Settings.CREAM_COLOR
      );
      FontHelper.renderFontCenteredWidth(
         sb, FontHelper.panelNameFont, LABEL[2], Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F - 360.0F * Settings.scale, Settings.GOLD_COLOR
      );
      FontHelper.renderFontCenteredWidth(
         sb,
         FontHelper.tipBodyFont,
         LABEL[3] + Integer.toString(Math.abs(this.currentSlot - 1)) + LABEL[4],
         Settings.WIDTH / 2.0F,
         Settings.HEIGHT / 2.0F - 400.0F * Settings.scale,
         Settings.CREAM_COLOR
      );
