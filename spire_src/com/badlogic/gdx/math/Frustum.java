...
public class Frustum {
   protected static final Vector3[] clipSpacePlanePoints = new Vector3[]{
   ...
   public final Vector3[] planePoints = new Vector3[]{
   ...
   public boolean boundsInFrustum(BoundingBox bounds) {
      ...
      for (int len2 = this.planes.length; i < len2; i++) {
         if (this.planes[i].testPoint(bounds.getCorner000(tmpV)) == Plane.PlaneSide.Back
            ...
            && this.planes[i].testPoint(bounds.getCorner110(tmpV)) == Plane.PlaneSide.Back
