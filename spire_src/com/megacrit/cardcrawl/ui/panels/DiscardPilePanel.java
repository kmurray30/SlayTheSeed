...
public class DiscardPilePanel extends AbstractPanel {
   ...
   public DiscardPilePanel() {
      super(Settings.WIDTH - 256.0F * Settings.scale, 0.0F, Settings.WIDTH, -300.0F * Settings.scale, 8.0F * Settings.xScale, 0.0F, null, true);
   }
   ...
   public void updatePositions() {
      ...
      if ((this.hb.clicked || InputActionSet.discardPile.isJustPressed() || CInputActionSet.discardPile.isJustPressed())
         && AbstractDungeon.screen == AbstractDungeon.CurrentScreen.DISCARD_VIEW) {
   ...
   public void render(SpriteBatch sb) {
      ...
      if (Settings.isControllerMode) {
         sb.draw(
            ...
            this.current_x - 32.0F + 220.0F * Settings.scale,
      ...
      if (this.isHidden
         ...
         || AbstractDungeon.getMonsters().areMonstersDead()) {
         this.hb.hovered = false;
      } else if (Settings.isConsoleBuild) {
