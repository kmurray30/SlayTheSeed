...
public class Designer extends AbstractImageEvent {
   ...
   private Designer.CurrentScreen curScreen = Designer.CurrentScreen.INTRO;
   private Designer.OptionChosen option = null;
   ...
   public Designer() {
      ...
      this.option = Designer.OptionChosen.NONE;
   ...
   public void update() {
      super.update();
      if (this.option != Designer.OptionChosen.NONE) {
         switch (this.option) {
            case REMOVE:
               if (!AbstractDungeon.isScreenUp && !AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
                  CardCrawlGame.sound.play("CARD_EXHAUST");
                  AbstractCard c = AbstractDungeon.gridSelectScreen.selectedCards.get(0);
                  logMetricCardRemovalAtCost("Designer", "Single Remove", c, this.cleanUpCost);
            ...
            case REMOVE_AND_UPGRADE:
               if (!AbstractDungeon.isScreenUp && !AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
                  ...
                  AbstractDungeon.topLevelEffects
                     .add(new PurgeCardEffect(removeCard, Settings.WIDTH / 2.0F - AbstractCard.IMG_WIDTH - 20.0F * Settings.scale, Settings.HEIGHT / 2.0F));
               ...
               if (!AbstractDungeon.isScreenUp && !AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
                  ...
                  if (AbstractDungeon.gridSelectScreen.selectedCards.size() == 2) {
                     ...
                     AbstractDungeon.effectsQueue
                        .add(
                           new ShowCardAndObtainEffect(
                              newCard1, Settings.WIDTH / 2.0F - AbstractCard.IMG_WIDTH / 2.0F - 20.0F * Settings.scale, Settings.HEIGHT / 2.0F
                           )
                        );
                     ...
                     AbstractDungeon.effectsQueue
                        .add(
                           new ShowCardAndObtainEffect(
                              newCard2, Settings.WIDTH / 2.0F + AbstractCard.IMG_WIDTH / 2.0F + 20.0F * Settings.scale, Settings.HEIGHT / 2.0F
                           )
                        );
                     AbstractDungeon.gridSelectScreen.selectedCards.clear();
                     logMetricTransformCardsAtCost("Designer", "Transformed Cards", transCards, obtainedCards, this.cleanUpCost);
                  } else {
                     AbstractCard c = AbstractDungeon.gridSelectScreen.selectedCards.get(0);
                     AbstractDungeon.player.masterDeck.removeCard(c);
                     AbstractDungeon.transformCard(c, false, AbstractDungeon.miscRng);
                     ...
                     AbstractDungeon.gridSelectScreen.selectedCards.clear();
                     logMetricTransformCardAtCost("Designer", "Transform", transCard, c, this.cleanUpCost);
                  }
            ...
            case UPGRADE:
               if (!AbstractDungeon.isScreenUp && !AbstractDungeon.gridSelectScreen.selectedCards.isEmpty()) {
                  logMetricCardUpgradeAtCost("Designer", "Upgrade", AbstractDungeon.gridSelectScreen.selectedCards.get(0), this.adjustCost);
         ...
         case INTRO:
            ...
            if (this.adjustmentUpgradesOne) {
               this.imageEventText
                  .updateDialogOption(
                     ...
                     AbstractDungeon.player.gold < this.adjustCost || !AbstractDungeon.player.masterDeck.hasUpgradableCards()
                  );
            } else {
               this.imageEventText
                  .updateDialogOption(
            ...
            if (this.cleanUpRemovesCards) {
               this.imageEventText
                  .setDialogOption(
                     ...
                     AbstractDungeon.player.gold < this.cleanUpCost || CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck).size() == 0
                  );
            } else {
               this.imageEventText
                  .setDialogOption(
                     OPTIONS[2] + this.cleanUpCost + OPTIONS[6] + OPTIONS[11] + 2 + OPTIONS[12],
                     AbstractDungeon.player.gold < this.cleanUpCost || CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck).size() < 2
                  );
            }
            ...
            this.imageEventText
               .setDialogOption(
                  ...
                  AbstractDungeon.player.gold < this.fullServiceCost || CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck).size() == 0
               );
            this.imageEventText.setDialogOption(OPTIONS[4] + this.hpLoss + OPTIONS[5]);
            this.curScreen = Designer.CurrentScreen.MAIN;
            break;
         case MAIN:
            switch (buttonPressed) {
               case 0:
                  ...
                  if (this.adjustmentUpgradesOne) {
                     this.option = Designer.OptionChosen.UPGRADE;
               ...
               case 1:
                  ...
                  if (this.cleanUpRemovesCards) {
                     this.option = Designer.OptionChosen.REMOVE;
                     ...
                     this.option = Designer.OptionChosen.TRANSFORM;
                     AbstractDungeon.gridSelectScreen
                        .open(
                           CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck.getPurgeableCards()),
                           2,
               ...
               case 2:
                  ...
                  this.option = Designer.OptionChosen.REMOVE_AND_UPGRADE;
                  AbstractDungeon.gridSelectScreen
                     .open(
                        CardGroup.getGroupWithoutBottledCards(AbstractDungeon.player.masterDeck.getPurgeableCards()), 1, OPTIONS[17], false, false, false, true
                     );
                  break;
               case 3:
            ...
            this.curScreen = Designer.CurrentScreen.DONE;
            break;
         case DONE:
         default:
            this.openMap();
   ...
   private void upgradeTwoRandomCards() {
      ...
      if (upgradableCards.isEmpty()) {
         ...
         AbstractDungeon.topLevelEffects.add(new UpgradeShineEffect(Settings.WIDTH / 2.0F, Settings.HEIGHT / 2.0F));
         logMetricCardUpgradeAtCost("Designer", "Tried to Upgrade", upgradableCards.get(0), this.adjustCost);
      } else {
