...
public final class GL40 {
   ...
   public static int glGetSubroutineUniformLocation(int program, int shadertype, ByteBuffer name) {
      ...
      return nglGetSubroutineUniformLocation(program, shadertype, MemoryUtil.getAddress(name), function_pointer);
   }
   ...
   public static int glGetSubroutineUniformLocation(int program, int shadertype, CharSequence name) {
      ...
      long function_pointer = caps.glGetSubroutineUniformLocation;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetSubroutineUniformLocation(program, shadertype, APIUtil.getBufferNT(caps, name), function_pointer);
   }
   ...
   public static int glGetSubroutineIndex(int program, int shadertype, ByteBuffer name) {
      ...
      BufferChecks.checkDirect(name);
      BufferChecks.checkNullTerminated(name);
      return nglGetSubroutineIndex(program, shadertype, MemoryUtil.getAddress(name), function_pointer);
   }
   ...
   public static int glGetSubroutineIndex(int program, int shadertype, CharSequence name) {
      ...
      long function_pointer = caps.glGetSubroutineIndex;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetSubroutineIndex(program, shadertype, APIUtil.getBufferNT(caps, name), function_pointer);
   }
   ...
   public static void glGetActiveSubroutineUniformName(int program, int shadertype, int index, IntBuffer length, ByteBuffer name) {
      ...
      nglGetActiveSubroutineUniformName(
         program, shadertype, index, name.remaining(), MemoryUtil.getAddressSafe(length), MemoryUtil.getAddress(name), function_pointer
      );
   }
   ...
   public static boolean glIsTransformFeedback(int id) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsTransformFeedback(id, function_pointer);
   }
