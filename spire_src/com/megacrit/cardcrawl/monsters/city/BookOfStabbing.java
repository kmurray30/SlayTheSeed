         ...
         case 1:
            ...
            for (int i = 0; i < this.stabCount; i++) {
               ...
               AbstractDungeon.actionManager
                  .addToBottom(new DamageAction(AbstractDungeon.player, this.damage.get(0), AbstractGameAction.AttackEffect.SLASH_VERTICAL, false, true));
            }
            break;
         case 2:
            ...
            AbstractDungeon.actionManager.addToBottom(new WaitAction(0.5F));
            AbstractDungeon.actionManager
               .addToBottom(new DamageAction(AbstractDungeon.player, this.damage.get(1), AbstractGameAction.AttackEffect.SLASH_VERTICAL));
      }
   ...
   protected void getMove(int num) {
      if (num < 15) {
         if (this.lastMove((byte)2)) {
            this.stabCount++;
            this.setMove((byte)1, AbstractMonster.Intent.ATTACK, this.damage.get(0).base, this.stabCount, true);
         } else {
