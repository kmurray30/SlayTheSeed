...
public final class Display {
      ...
      synchronized (GlobalLock.lock) {
         if (isCreated()) {
            ...
            DrawableGLES drawable = new DrawableGLES() {
               @Override
               public void setPixelFormat(PixelFormatLWJGL pf, ContextAttribs attribsx) throws LWJGLException {
   ...
   public static int getWidth() {
      if (isFullscreen()) {
         ...
         return parent != null ? parent.getWidth() : width;
      }
   }
   ...
   public static int getHeight() {
      if (isFullscreen()) {
         ...
         return parent != null ? parent.getHeight() : height;
      }
   }
