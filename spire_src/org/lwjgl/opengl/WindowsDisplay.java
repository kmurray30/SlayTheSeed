...
final class WindowsDisplay implements DisplayImplementation {
   ...
   private void updateClipping() {
      if ((Display.isFullscreen() || this.mouse != null && this.mouse.isGrabbed())
         && !this.isMinimized
         && this.isFocused
         && (getForegroundWindow() == this.getHwnd() || hasParent)) {
         try {
   ...
   private long doHandleMessage(long hwnd, int msg, long wParam, long lParam, long millis) {
      ...
      switch (msg) {
         ...
         case 512:
            int xPos = (short)(lParam & 65535L);
            int yPos = transformY(this.getHwnd(), (short)(lParam >> 16 & 65535L));
         ...
         case 520:
            ...
            return 0L;
         case 522:
            int dwheel = (short)(wParam >> 16 & 65535L);
   ...
   public void setResizable(boolean resizable) {
      if (this.resizable != resizable) {
         ...
         int var4;
         setWindowLongPtr(this.hwnd, -16, var4 = resizable && !Display.isFullscreen() ? style | 327680 : style & -327681);
         getGlobalClientRect(this.hwnd, rect);
         rect.copyToBuffer(rect_buffer);
         this.adjustWindowRectEx(rect_buffer, var4, false, styleex);
         rect.copyFromBuffer(rect_buffer);
