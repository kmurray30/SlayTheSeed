...
class Drft {
            ...
            case 107:
               if (nl == 1) {
                  ...
                  for (int k1 = 0; k1 < nfm1; k1++) {
                     ...
                     for (int var29 = 0; var29 < ipm; var29++) {
                        ld += l1;
                        int var27 = is;
                        float argld = ld * argh;
                        float fi = 0.0F;
                        ...
                        for (int ii = 2; ii < ido; ii += 2) {
                           float arg = ++fi * argld;
                           wa[index + var27++] = (float)Math.cos(arg);
                           wa[index + var27++] = (float)Math.sin(arg);
                        }
   ...
   static void dradf4(int ido, int l1, float[] cc, float[] ch, float[] wa1, int index1, float[] wa2, int index2, float[] wa3, int index3) {
      ...
      for (int k = 0; k < l1; k++) {
         ...
         int var45;
         ch[(var45 = t5 + (ido << 1)) - 1] = cc[t3] - cc[t4];
         ch[var45] = cc[t2] - cc[t1];
         t1 += ido;
         t2 += ido;
         t3 += ido;
         t4 += ido;
         ...
         switch (state) {
            ...
            case 132:
               for (int i = 0; i < ido; i++) {
                  ...
                  for (int var64 = 0; var64 < l1; var64++) {
                     cc[t2] = ch[var78];
                     var78 += ido;
                     t2 += t10;
                  }
            ...
            case 135:
               ...
               for (int var54 = 1; var54 < ipph; var54++) {
                  t1 += t2;
                  var94 += t0;
                  t4 -= t0;
                  int t5 = t1;
               ...
               if (nbd >= l1) {
                  ...
                  for (int var55 = 1; var55 < ipph; var55++) {
                     ...
                     for (int k = 0; k < l1; k++) {
                        for (int var48 = 2; var48 < ido; var48 += 2) {
                           int ic = idp2 - var48;
                           cc[var48 + t7 - 1] = ch[var48 + t8 - 1] + ch[var48 + t9 - 1];
                           cc[ic + t6 - 1] = ch[var48 + t8 - 1] - ch[var48 + t9 - 1];
                           cc[var48 + t7] = ch[var48 + t8] + ch[var48 + t9];
                           cc[ic + t6] = ch[var48 + t9] - ch[var48 + t8];
                        }
   ...
   static void dradb4(int ido, int l1, float[] cc, float[] ch, float[] wa1, int index1, float[] wa2, int index2, float[] wa3, int index3) {
      ...
      for (int k = 0; k < l1; k++) {
         ...
         int var43;
         float tr1 = cc[t3] - cc[(var43 = t4 + t6) - 1];
         float tr2 = cc[t3] + cc[var43 - 1];
         ch[t1] = tr2 + tr3;
         int t5;
         ch[t5 = t1 + t0] = tr1 - tr4;
         int var46;
         ch[var46 = t5 + t0] = tr2 - tr3;
         ch[t5 = var46 + t0] = tr1 + tr4;
         t1 += ido;
         t3 += t2;
      }
      ...
      if (ido >= 2) {
         if (ido != 2) {
            ...
            for (int var35 = 0; var35 < l1; var35++) {
               ...
               for (int i = 2; i < ido; i += 2) {
                  ...
                  int var52;
                  ch[(var52 = t8 + t0) - 1] = wa2[index2 + i - 2] * cr3 - wa2[index2 + i - 1] * ci3;
                  ch[var52] = wa2[index2 + i - 2] * ci3 + wa2[index2 + i - 1] * cr3;
                  ch[(t8 = var52 + t0) - 1] = wa3[index3 + i - 2] * cr4 - wa3[index3 + i - 1] * ci4;
         ...
         for (int var36 = 0; var36 < l1; var36++) {
            ...
            ch[t3] = tr2 + tr2;
            int var49;
            ch[var49 = t3 + t0] = sqrt2 * (tr1 - ti1);
            int var50;
            ch[var50 = var49 + t0] = ti2 + ti2;
            ch[var49 = var50 + t0] = -sqrt2 * (tr1 + ti1);
            t3 += ido;
            t1 += t2;
            t4 += t2;
         }
         ...
         switch (state) {
            ...
            case 103:
               ...
               for (int i = 0; i < ido; i++) {
                  ...
                  for (int var70 = 0; var70 < l1; var70++) {
                     ch[var98] = cc[t3];
                     var98 += ido;
                     t3 += t10;
                  }
               ...
               if (ido == 1) {
                  ...
                  for (int var63 = 1; var63 < ipph; var63++) {
                     ...
                     for (int k = 0; k < l1; k++) {
                        ...
                        for (int var52 = 2; var52 < ido; var52 += 2) {
                           t5 += 2;
                           t6 += 2;
                           t9 += 2;
                           t11 -= 2;
            ...
            case 112:
               ...
               for (int var57 = 1; var57 < ipph; var57++) {
                  ...
                  for (int i = 2; i < ido; i += 2) {
                     ...
                     for (int k = 0; k < l1; k++) {
                        ch[var120 - 1] = cc[t11 - 1] + cc[t12 - 1];
                        ch[t6 - 1] = cc[t11 - 1] - cc[t12 - 1];
                        ch[var120] = cc[t11] - cc[t12];
                        ch[t6] = cc[t11] + cc[t12];
                        var120 += ido;
                        t6 += ido;
                        t11 += t10;
            ...
            case 132:
               ...
               for (int var55 = 1; var55 < ip; var55++) {
                  int var91 = var79 += t0;
