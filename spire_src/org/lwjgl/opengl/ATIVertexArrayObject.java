...
public final class ATIVertexArrayObject {
   ...
   public static int glNewObjectBufferATI(int pPointer_size, int usage) {
      ...
      return nglNewObjectBufferATI(pPointer_size, 0L, usage, function_pointer);
   }
   ...
   public static int glNewObjectBufferATI(ByteBuffer pPointer, int usage) {
      ...
      return nglNewObjectBufferATI(pPointer.remaining(), MemoryUtil.getAddress(pPointer), usage, function_pointer);
   }
   ...
   public static int glNewObjectBufferATI(DoubleBuffer pPointer, int usage) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(pPointer);
      return nglNewObjectBufferATI(pPointer.remaining() << 3, MemoryUtil.getAddress(pPointer), usage, function_pointer);
   }
   ...
   public static int glNewObjectBufferATI(FloatBuffer pPointer, int usage) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(pPointer);
      return nglNewObjectBufferATI(pPointer.remaining() << 2, MemoryUtil.getAddress(pPointer), usage, function_pointer);
   }
   ...
   public static int glNewObjectBufferATI(ShortBuffer pPointer, int usage) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      BufferChecks.checkDirect(pPointer);
      return nglNewObjectBufferATI(pPointer.remaining() << 1, MemoryUtil.getAddress(pPointer), usage, function_pointer);
   }
   ...
   public static boolean glIsObjectBufferATI(int buffer) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsObjectBufferATI(buffer, function_pointer);
   }
