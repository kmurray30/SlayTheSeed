...
public class Rectangle implements Serializable, Shape2D {
   ...
   public boolean contains(Circle circle) {
      return circle.x - circle.radius >= this.x
   ...
   public boolean contains(Rectangle rectangle) {
      ...
      return xmin > this.x
         && xmin < this.x + this.width
         && xmax > this.x
         && xmax < this.x + this.width
         && ymin > this.y
         && ymin < this.y + this.height
         && ymax > this.y
   ...
   public int hashCode() {
      ...
      return 31 * result + NumberUtils.floatToRawIntBits(this.y);
   }
   ...
   public boolean equals(Object obj) {
      if (this == obj) {
         ...
         if (NumberUtils.floatToRawIntBits(this.height) != NumberUtils.floatToRawIntBits(other.height)) {
            return false;
         } else if (NumberUtils.floatToRawIntBits(this.width) != NumberUtils.floatToRawIntBits(other.width)) {
            return false;
         } else {
            return NumberUtils.floatToRawIntBits(this.x) != NumberUtils.floatToRawIntBits(other.x)
               ? false
