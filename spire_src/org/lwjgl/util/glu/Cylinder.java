      ...
      if (super.drawStyle == 100010) {
         ...
         if (super.drawStyle == 100011) {
            ...
            for (int i = 0; i < slices; i++) {
               ...
               float yx = this.sin(i * da);
               this.normal3f(xx * nsign, yx * nsign, nz * nsign);
               GL11.glVertex3f(xx * baseRadius, yx * baseRadius, 0.0F);
            }

            GL11.glEnd();
            GL11.glBegin(2);

            for (int var36 = 0; var36 < slices; var36++) {
               float xx = this.cos(var36 * da);
               float yx = this.sin(var36 * da);
               this.normal3f(xx * nsign, yx * nsign, nz * nsign);
               GL11.glVertex3f(xx * topRadius, yx * topRadius, height);
            }
