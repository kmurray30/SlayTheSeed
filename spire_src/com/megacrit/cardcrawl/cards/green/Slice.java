...
extends AbstractCard {
    ...
    public Slice() {
        super(ID, Slice.cardStrings.NAME, "green/attack/slice", 0, Slice.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.GREEN, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 6;
    }
