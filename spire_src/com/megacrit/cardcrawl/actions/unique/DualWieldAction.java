...
extends AbstractGameAction {
    ...
    public static final String[] TEXT = DualWieldAction.uiStrings.TEXT;
    ...
    public void update() {
        if (this.duration == Settings.ACTION_DUR_FAST) {
            for (AbstractCard c : this.p.hand.group) {
                if (this.isDualWieldable(c)) continue;
    ...
    private boolean isDualWieldable(AbstractCard card) {
        return card.type.equals((Object)AbstractCard.CardType.ATTACK) || card.type.equals((Object)AbstractCard.CardType.POWER);
    }
}
