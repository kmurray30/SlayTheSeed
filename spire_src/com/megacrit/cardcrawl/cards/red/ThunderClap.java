...
public class ThunderClap extends AbstractCard {
   ...
   public void use(AbstractPlayer p, AbstractMonster m) {
      ...
      for (AbstractMonster mox : AbstractDungeon.getCurrRoom().monsters.monsters) {
         this.addToBot(new ApplyPowerAction(mox, p, new VulnerablePower(mox, 1, false), 1, true, AbstractGameAction.AttackEffect.NONE));
      }
   }
