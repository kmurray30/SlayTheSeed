...
public class UncommonPotionParticleEffect
extends AbstractGameEffect {
    ...
    @Override
    public void update() {
        this.color.a = this.duration > this.dur_div2 ? Interpolation.pow3In.apply(0.5f, 0.0f, (this.duration - this.dur_div2) / this.dur_div2) : Interpolation.pow3In.apply(0.0f, 0.5f, this.duration / this.dur_div2);
    ...
    public void render(SpriteBatch sb) {
        ...
        if (this.hb != null) {
            sb.draw(this.img, this.hb.cX + this.oX, this.hb.cY + this.oY, (float)this.img.packedWidth / 2.0f, (float)this.img.packedHeight / 2.0f, this.img.packedWidth, this.img.packedHeight, this.scale * MathUtils.random(0.8f, 1.2f), this.scale * MathUtils.random(0.8f, 1.2f), this.rotation);
        } else {
            sb.draw(this.img, this.x + this.oX, this.y + this.oY, (float)this.img.packedWidth / 2.0f, (float)this.img.packedHeight / 2.0f, this.img.packedWidth, this.img.packedHeight, this.scale * MathUtils.random(0.8f, 1.2f), this.scale * MathUtils.random(0.8f, 1.2f), this.rotation);
        }
