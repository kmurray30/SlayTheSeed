...
extends AbstractCard {
    ...
    public SimmeringFury() {
        super(ID, SimmeringFury.cardStrings.NAME, "purple/skill/simmering_fury", 1, SimmeringFury.cardStrings.DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.PURPLE, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.NONE);
