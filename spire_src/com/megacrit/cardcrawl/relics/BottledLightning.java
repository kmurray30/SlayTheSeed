...
extends AbstractRelic {
    ...
    public BottledLightning() {
        super(ID, "bottledLightning.png", AbstractRelic.RelicTier.UNCOMMON, AbstractRelic.LandingSound.CLINK);
    }
    ...
    public boolean canSpawn() {
        for (AbstractCard c : AbstractDungeon.player.masterDeck.group) {
            if (c.type != AbstractCard.CardType.SKILL || c.rarity == AbstractCard.CardRarity.BASIC) continue;
            return true;
        }
        return false;
    }
