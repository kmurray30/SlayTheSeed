...
public abstract class BaseTmxMapLoader<P extends AssetLoaderParameters<TiledMap>> extends AsynchronousAssetLoader<TiledMap, P> {
      ...
      if (element.getName().equals("layer")) {
         ...
         for (int y = 0; y < height; y++) {
            for (int x = 0; x < width; x++) {
               ...
               boolean flipHorizontally = (id & -2147483648) != 0;
   ...
   protected void loadObject(TiledMap map, MapLayer layer, XmlReader.Element element) {
      if (element.getName().equals("object")) {
         ...
         float scaleX = this.convertObjectToTileSpace ? 1.0F / this.mapTileWidth : 1.0F;
         float scaleY = this.convertObjectToTileSpace ? 1.0F / this.mapTileHeight : 1.0F;
         float x = element.getFloatAttribute("x", 0.0F) * scaleX;
         float y = (this.flipY ? this.mapHeightInPixels - element.getFloatAttribute("y", 0.0F) : element.getFloatAttribute("y", 0.0F)) * scaleY;
         ...
         if (object == null) {
            ...
            if ((gid = element.getAttribute("gid", null)) != null) {
               ...
               boolean flipHorizontally = (id & -2147483648) != 0;
               boolean flipVertically = (id & 1073741824) != 0;
               TiledMapTile tile = map.getTileSets().getTile(id & 536870911);
      ...
      if (encoding == null) {
         ...
         if (encoding.equals("csv")) {
            ...
            try {
               ...
               throw new GdxRuntimeException("Error Reading TMX Layer Data - IOException: " + var17.getMessage());
            } finally {
