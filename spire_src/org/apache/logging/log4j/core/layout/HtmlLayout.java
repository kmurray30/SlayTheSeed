...
public final class HtmlLayout extends AbstractStringLayout {
   ...
   public static HtmlLayout createLayout(
      ...
      @PluginAttribute(value = "title", defaultString = "Log4j Log Messages") final String title,
      @PluginAttribute("contentType") String contentType,
      @PluginAttribute(value = "charset", defaultString = "UTF-8") final Charset charset,
      @PluginAttribute("fontSize") String fontSize,
      @PluginAttribute(value = "fontName", defaultString = "arial,sans-serif") final String font
   ) {
   ...
   public static class Builder implements org.apache.logging.log4j.core.util.Builder<HtmlLayout> {
      ...
      public HtmlLayout.Builder withLocationInfo(final boolean locationInfo) {
         this.locationInfo = locationInfo;
         return this;
      }

      public HtmlLayout.Builder withTitle(final String title) {
         this.title = title;
         return this;
      }

      public HtmlLayout.Builder withContentType(final String contentType) {
         this.contentType = contentType;
         return this;
      }

      public HtmlLayout.Builder withCharset(final Charset charset) {
         this.charset = charset;
         return this;
      }

      public HtmlLayout.Builder withFontSize(final HtmlLayout.FontSize fontSize) {
         this.fontSize = fontSize;
         return this;
      }

      public HtmlLayout.Builder withFontName(final String fontName) {
         this.fontName = fontName;
         return this;
      }

      public HtmlLayout.Builder setDatePattern(final String datePattern) {
         this.datePattern = datePattern;
         return this;
      }

      public HtmlLayout.Builder setTimezone(final String timezone) {
      ...
      public HtmlLayout build() {
         ...
         return new HtmlLayout(
            ...
            this.fontSize.larger().getFontSize(),
            this.datePattern,
            this.timezone
         );
      }
   ...
   public static enum FontSize {
      ...
      public static HtmlLayout.FontSize getFontSize(final String size) {
