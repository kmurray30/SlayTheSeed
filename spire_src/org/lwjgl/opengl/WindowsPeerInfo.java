...
abstract class WindowsPeerInfo extends PeerInfo {
   ...
   protected static int choosePixelFormat(
      long hdc,
      int origin_x,
      int origin_y,
      PixelFormat pixel_format,
      IntBuffer pixel_format_caps,
      boolean use_hdc_bpp,
      boolean support_window,
      boolean support_pbuffer,
   ...
   private static native int nChoosePixelFormat(
      long var0, int var2, int var3, PixelFormat var4, IntBuffer var5, boolean var6, boolean var7, boolean var8, boolean var9
   ) throws LWJGLException;
