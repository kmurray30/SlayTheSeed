...
extends AbstractCard {
    ...
    public CutThroughFate() {
        super(ID, CutThroughFate.cardStrings.NAME, "purple/attack/cut_through_fate", 1, CutThroughFate.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.PURPLE, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 7;
