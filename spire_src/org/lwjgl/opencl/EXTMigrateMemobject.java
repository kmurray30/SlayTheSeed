...
public final class EXTMigrateMemobject {
   ...
   public static int clEnqueueMigrateMemObjectEXT(
      ...
      int __result = nclEnqueueMigrateMemObjectEXT(
   ...
   public static int clEnqueueMigrateMemObjectEXT(
      CLCommandQueue command_queue, CLMem mem_object, long flags, PointerBuffer event_wait_list, PointerBuffer event
   ) {
      long function_pointer = CLCapabilities.clEnqueueMigrateMemObjectEXT;
      BufferChecks.checkFunctionAddress(function_pointer);
      if (event_wait_list != null) {
