...
class Floor0 extends FuncFloor {
   ...
   Object look(DspState vd, InfoMode mi, Object i) {
      ...
      float scale = look.ln / toBARK((float)(info.rate / 2.0));
      ...
      if (ampraw > 0) {
         ...
         if (booknum != -1 && booknum < info.numbooks) {
            synchronized (this) {
               ...
               for (int jx = 0; jx < look.m; last = this.lsp[jx - 1]) {
                  for (int k = 0; k < b.dim; jx++) {
                     this.lsp[jx] = this.lsp[jx] + last;
                     k++;
                  }
               }
   ...
   Object inverse1(Block vb, Object i, Object memo) {
      ...
      if (ampraw > 0) {
         ...
         if (booknum != -1 && booknum < info.numbooks) {
            ...
            for (int jx = 0; jx < look.m; last = lsp[jx - 1]) {
               for (int k = 0; k < b.dim; jx++) {
                  lsp[jx] += last;
                  k++;
               }
