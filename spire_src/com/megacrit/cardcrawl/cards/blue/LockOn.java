...
extends AbstractCard {
    ...
    public LockOn() {
        super(ID, LockOn.cardStrings.NAME, "blue/attack/lock_on", 1, LockOn.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.BLUE, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 8;
