...
extends AbstractCard {
    ...
    public Flex() {
        super(ID, Flex.cardStrings.NAME, "red/skill/flex", 0, Flex.cardStrings.DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.RED, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.SELF);
