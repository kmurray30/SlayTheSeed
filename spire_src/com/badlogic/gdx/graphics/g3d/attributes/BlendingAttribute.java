...
public class BlendingAttribute extends Attribute {
   ...
   public BlendingAttribute(BlendingAttribute copyFrom) {
      this(
         copyFrom == null ? true : copyFrom.blended,
         copyFrom == null ? 770 : copyFrom.sourceFunction,
         copyFrom == null ? 771 : copyFrom.destFunction,
         copyFrom == null ? 1.0F : copyFrom.opacity
      );
   }
   ...
   public int hashCode() {
      ...
      return 947 * result + NumberUtils.floatToRawIntBits(this.opacity);
   }
