...
class LwjglGL30 extends LwjglGL20 implements GL30 {
   @Override
   ...
   public void glTexSubImage3D(
      int target, int level, int xoffset, int yoffset, int zoffset, int width, int height, int depth, int format, int type, Buffer pixels
   ) {
