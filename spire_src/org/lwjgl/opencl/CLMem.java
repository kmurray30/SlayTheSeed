...
public final class CLMem extends CLObjectChild<CLContext> {
   private static final CLMem.CLMemUtil util = (CLMem.CLMemUtil)CLPlatform.<CLMem>getInfoUtilInstance(CLMem.class, "CL_MEM_UTIL");
   ...
   public static CLMem createImage2D(
      CLContext context,
      long flags,
   ...
   public static CLMem createImage3D(
      CLContext context,
      long flags,
      CLImageFormat image_format,
      long image_width,
