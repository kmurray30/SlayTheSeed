...
public class ToggleButton {
   ...
   public ToggleButton(float x, float y, float middleY, ToggleButton.ToggleBtnType type) {
      this.x = x;
   ...
   public ToggleButton(float x, float y, float middleY, ToggleButton.ToggleBtnType type, boolean isLarge) {
      this.x = x;
      this.y = middleY + y * Settings.scale;
      this.type = type;
      if (isLarge) {
