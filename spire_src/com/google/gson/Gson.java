...
public final class Gson {
   ...
   Gson(
      ...
      factories.add(TypeAdapters.newFactory(long.class, Long.class, this.longAdapter(longSerializationPolicy)));
   ...
   public <T> TypeAdapter<T> getAdapter(TypeToken<T> type) {
      ...
      if (cached != null) {
         ...
         Map<TypeToken<?>, Gson.FutureTypeAdapter<?>> threadCalls = this.calls.get();
