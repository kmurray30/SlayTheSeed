...
public final class CLCapabilities {
   ...
   private static boolean isCL10Supported() {
      return clGetPlatformIDs != 0L
         & clGetPlatformInfo != 0L
         & clGetDeviceIDs != 0L
         & clGetDeviceInfo != 0L
         & clCreateContext != 0L
         & clCreateContextFromType != 0L
         & clRetainContext != 0L
         & clReleaseContext != 0L
         & clGetContextInfo != 0L
         & clCreateCommandQueue != 0L
         & clRetainCommandQueue != 0L
         & clReleaseCommandQueue != 0L
         & clGetCommandQueueInfo != 0L
         & clCreateBuffer != 0L
         & clEnqueueReadBuffer != 0L
         & clEnqueueWriteBuffer != 0L
         & clEnqueueCopyBuffer != 0L
         & clEnqueueMapBuffer != 0L
         & clCreateImage2D != 0L
         & clCreateImage3D != 0L
         & clGetSupportedImageFormats != 0L
         & clEnqueueReadImage != 0L
         & clEnqueueWriteImage != 0L
         & clEnqueueCopyImage != 0L
         & clEnqueueCopyImageToBuffer != 0L
         & clEnqueueCopyBufferToImage != 0L
         & clEnqueueMapImage != 0L
         & clGetImageInfo != 0L
         & clRetainMemObject != 0L
         & clReleaseMemObject != 0L
         & clEnqueueUnmapMemObject != 0L
         & clGetMemObjectInfo != 0L
         & clCreateSampler != 0L
         & clRetainSampler != 0L
         & clReleaseSampler != 0L
         & clGetSamplerInfo != 0L
         & clCreateProgramWithSource != 0L
         & clCreateProgramWithBinary != 0L
         & clRetainProgram != 0L
         & clReleaseProgram != 0L
         & clBuildProgram != 0L
         & clUnloadCompiler != 0L
         & clGetProgramInfo != 0L
         & clGetProgramBuildInfo != 0L
         & clCreateKernel != 0L
         & clCreateKernelsInProgram != 0L
         & clRetainKernel != 0L
         & clReleaseKernel != 0L
         & clSetKernelArg != 0L
         & clGetKernelInfo != 0L
         & clGetKernelWorkGroupInfo != 0L
         & clEnqueueNDRangeKernel != 0L
         & clEnqueueTask != 0L
         & clEnqueueNativeKernel != 0L
         & clWaitForEvents != 0L
         & clGetEventInfo != 0L
         & clRetainEvent != 0L
         & clReleaseEvent != 0L
         & clEnqueueMarker != 0L
         & clEnqueueBarrier != 0L
         & clEnqueueWaitForEvents != 0L
         & clGetEventProfilingInfo != 0L
         & clFlush != 0L
         & clFinish != 0L
         & clGetExtensionFunctionAddress != 0L;
   }

   private static boolean isCL10GLSupported() {
      return clCreateFromGLBuffer != 0L
         & clCreateFromGLTexture2D != 0L
         & clCreateFromGLTexture3D != 0L
         & clCreateFromGLRenderbuffer != 0L
         & clGetGLObjectInfo != 0L
         & clGetGLTextureInfo != 0L
         & clEnqueueAcquireGLObjects != 0L
         & clEnqueueReleaseGLObjects != 0L;
   }

   private static boolean isCL11Supported() {
      return clCreateSubBuffer != 0L
         & clSetMemObjectDestructorCallback != 0L
         & clEnqueueReadBufferRect != 0L
         & clEnqueueWriteBufferRect != 0L
         & clEnqueueCopyBufferRect != 0L
         & clCreateUserEvent != 0L
         & clSetUserEventStatus != 0L
         & clSetEventCallback != 0L;
   }

   private static boolean isCL12Supported() {
      boolean var10000 = clRetainDevice != 0L
         & clReleaseDevice != 0L
         & clCreateSubDevices != 0L
         & clCreateImage != 0L
         & clCreateProgramWithBuiltInKernels != 0L
         & clCompileProgram != 0L
         & clLinkProgram != 0L
         & clUnloadPlatformCompiler != 0L
         & clGetKernelArgInfo != 0L
         & clEnqueueFillBuffer != 0L
         & clEnqueueFillImage != 0L
         & clEnqueueMigrateMemObjects != 0L
         & clEnqueueMarkerWithWaitList != 0L
