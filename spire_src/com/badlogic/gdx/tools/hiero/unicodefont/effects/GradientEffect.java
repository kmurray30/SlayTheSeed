...
implements ConfigurableEffect {
    ...
    public List getValues() {
        ...
        values.add(EffectUtil.floatValue("Scale", this.scale, 0.0f, 10.0f, "This setting allows you to change the height of the gradient by apercentage. The gradient is normally the height of most glyphs in the font."));
