...
public class JsonReader implements Closeable {
   ...
   public void endArray() throws IOException {
      ...
      if (p == 4) {
         ...
         throw new IllegalStateException(
            "Expected END_ARRAY but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath()
         );
      }
   }
   ...
   public void endObject() throws IOException {
      ...
      if (p == 2) {
         ...
         throw new IllegalStateException(
            "Expected END_OBJECT but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath()
         );
      }
   }
   ...
   public String nextName() throws IOException {
      ...
      if (p == 14) {
         ...
         if (p != 13) {
            throw new IllegalStateException(
               "Expected a name but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath()
            );
         }
   ...
   public boolean nextBoolean() throws IOException {
      ...
      if (p == 5) {
         ...
         throw new IllegalStateException(
            "Expected a boolean but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath()
         );
      }
   }
   ...
   public void nextNull() throws IOException {
      ...
      if (p == 7) {
         ...
         throw new IllegalStateException(
            "Expected null but was " + this.peek() + " at line " + this.getLineNumber() + " column " + this.getColumnNumber() + " path " + this.getPath()
         );
      }
   }
   ...
   private void consumeNonExecutePrefix() throws IOException {
      ...
      if (this.pos + NON_EXECUTE_PREFIX.length <= this.limit || this.fillBuffer(NON_EXECUTE_PREFIX.length)) {
         ...
         this.pos = this.pos + NON_EXECUTE_PREFIX.length;
      }
   }
