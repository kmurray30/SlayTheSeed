...
extends AbstractCard {
    ...
    public Eviscerate() {
        super(ID, Eviscerate.cardStrings.NAME, "green/attack/eviscerate", 3, Eviscerate.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.GREEN, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 7;
    }
