...
extends AbstractCard {
    ...
    public DEPRECATEDFlow() {
        super(ID, DEPRECATEDFlow.cardStrings.NAME, "green/power/after_image", 3, DEPRECATEDFlow.cardStrings.DESCRIPTION, AbstractCard.CardType.POWER, AbstractCard.CardColor.PURPLE, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
    }
