...
public final class ARBRobustness {
   ...
   public static int glGetGraphicsResetStatusARB() {
      ...
      return nglGetGraphicsResetStatusARB(function_pointer);
   }
   ...
   public static void glGetnSeparableFilterARB(
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      GLChecks.ensurePackPBOenabled(caps);
      nglGetnSeparableFilterARBBO(
         target, format, type, row_rowBufSize, row_buffer_offset, column_columnBufSize, column_buffer_offset, span_buffer_offset, function_pointer
      );
   }
