...
extends AbstractCard {
    ...
    public Rupture() {
        super(ID, Rupture.cardStrings.NAME, "red/power/rupture", 1, Rupture.cardStrings.DESCRIPTION, AbstractCard.CardType.POWER, AbstractCard.CardColor.RED, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
