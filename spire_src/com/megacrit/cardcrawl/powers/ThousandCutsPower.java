...
public class ThousandCutsPower
extends AbstractPower {
    ...
    public static final String NAME = ThousandCutsPower.powerStrings.NAME;
    public static final String[] DESCRIPTIONS = ThousandCutsPower.powerStrings.DESCRIPTIONS;
