...
public class TheBeyondScene extends AbstractScene {
   ...
   private TheBeyondScene.ColumnConfig columnConfig = TheBeyondScene.ColumnConfig.OPEN;
   ...
   public void randomizeScene() {
      ...
      if (MathUtils.randomBoolean(0.6F)) {
         this.columnConfig = TheBeyondScene.ColumnConfig.OPEN;
      } else if (MathUtils.randomBoolean()) {
         this.columnConfig = TheBeyondScene.ColumnConfig.SMALL_ONLY;
      } else if (MathUtils.randomBoolean()) {
         this.columnConfig = TheBeyondScene.ColumnConfig.SMALL_PLUS_LEFT;
      } else {
         this.columnConfig = TheBeyondScene.ColumnConfig.SMALL_PLUS_RIGHT;
      }
   ...
   public void renderCombatRoomBg(SpriteBatch sb) {
      ...
      this.renderAtlasRegionIf(
         sb,
         MathUtils.cosDeg((float)((System.currentTimeMillis() + 180L) / 180L % 360L)) * 40.0F * Settings.xScale,
         MathUtils.cosDeg((float)((System.currentTimeMillis() + 500L) / 72L % 360L)) * 20.0F * Settings.scale,
         MathUtils.cosDeg((float)((System.currentTimeMillis() + 180L) / 180L % 360L)),
         this.f1,
         this.renderF1
      );
      this.renderAtlasRegionIf(
         sb,
         MathUtils.cosDeg((float)((System.currentTimeMillis() + 91723L) / 72L % 360L)) * 20.0F,
         0.0F,
         (float)(System.currentTimeMillis() / 120L % 360L),
         this.f2,
         this.renderF2
      );
      this.renderAtlasRegionIf(
         ...
         MathUtils.cosDeg((float)(System.currentTimeMillis() + 73L)) * 10.0F - 90.0F * Settings.scale,
         (float)(System.currentTimeMillis() / 1000L % 360L) * 2.0F,
         this.f3,
         this.renderF3
      );
      this.renderAtlasRegionIf(
         sb,
         0.0F,
         MathUtils.cosDeg((float)((System.currentTimeMillis() + 4442L) / 20L % 360L)) * 30.0F * Settings.scale,
         MathUtils.cosDeg((float)((System.currentTimeMillis() + 4442L) / 10L % 360L)) * 20.0F,
         this.f4,
         this.renderF4
      );
