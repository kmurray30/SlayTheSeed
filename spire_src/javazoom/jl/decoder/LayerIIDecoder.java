...
public class LayerIIDecoder extends LayerIDecoder implements FrameDecoder {
   ...
   static class SubbandLayer2 extends LayerIDecoder.Subband {
      ...
      public static final float[] grouping_10bits = new float[]{
         -0.8888889F,
         -0.8888889F,
         -0.8888889F,
         -0.6666667F,
      ...
      public static final float[][] table_ab1_groupingtables = new float[][]{
         null, grouping_5bits, null, null, null, null, null, null, null, null, null, null, null, null, null, null
      };
      public static final float[] table_ab1_factor = new float[]{
         0.0F,
         0.5F,
         0.25F,
         0.125F,
      ...
      public static final float[] table_ab1_c = new float[]{
         0.0F,
         1.3333334F,
         1.1428572F,
         1.0666667F,
      ...
      public static final float[] table_ab1_d = new float[]{
         0.0F,
         0.5F,
         0.25F,
         0.125F,
      ...
      public static final float[][] table_ab234_groupingtables = new float[][]{
      ...
      public static final float[] table_ab2_factor = new float[]{
         0.0F,
         0.5F,
         0.25F,
         0.25F,
      ...
      public static final float[] table_ab2_c = new float[]{
         0.0F,
         1.3333334F,
         1.6F,
         1.1428572F,
      ...
      public static final float[] table_ab2_d = new float[]{
         0.0F,
         0.5F,
         0.5F,
         0.25F,
      ...
      public static final float[][] table_cd_groupingtables = new float[][]{
         null, grouping_5bits, grouping_7bits, grouping_10bits, null, null, null, null, null, null, null, null, null, null, null, null
      };
      public static final float[] table_cd_factor = new float[]{
         0.0F,
         0.5F,
         0.25F,
         0.125F,
      ...
      public static final float[] table_cd_c = new float[]{
         0.0F,
         1.3333334F,
         1.6F,
         1.7777778F,
      ...
      public static final float[] table_cd_d = new float[]{
         0.0F,
         0.5F,
         0.5F,
         0.5F,
         ...
         if (header.version() == 1) {
            ...
            if (channel_bitrate != 1 && channel_bitrate != 2) {
               if (this.subbandnumber <= 10) {
                  ...
                  return this.subbandnumber <= 22 ? 3 : 2;
               }
            } else {
               return this.subbandnumber <= 1 ? 4 : 3;
            }
         } else if (this.subbandnumber <= 3) {
            return 4;
         } else {
            return this.subbandnumber <= 10 ? 3 : 2;
         }
      }
         ...
         if (this.allocation != 0) {
            switch (this.scfsi) {
               ...
               case 1:
                  ...
                  break;
               case 2:
                  this.scalefactor1 = this.scalefactor2 = this.scalefactor3 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                  break;
               case 3:
                  this.scalefactor1 = LayerIDecoder.scalefactors[stream.get_bits(6)];
         ...
         if (this.allocation != 0) {
            ...
            switch (this.channel2_scfsi) {
               ...
               case 1:
                  ...
                  break;
               case 2:
                  this.channel2_scalefactor1 = this.channel2_scalefactor2 = this.channel2_scalefactor3 = LayerIDecoder.scalefactors[stream.get_bits(6)];
                  break;
               case 3:
                  this.channel2_scalefactor1 = LayerIDecoder.scalefactors[stream.get_bits(6)];
      ...
      public boolean put_next_sample(int channels, SynthesisFilter filter1, SynthesisFilter filter2) {
         if (this.allocation != 0) {
            ...
            if (channels == 0) {
               ...
               if (this.groupnumber <= 4) {
                  sample *= this.scalefactor1;
                  var9 = sample * this.channel2_scalefactor1;
               } else if (this.groupnumber <= 8) {
                  sample *= this.scalefactor2;
                  var9 = sample * this.channel2_scalefactor2;
               } else {
                  sample *= this.scalefactor3;
                  var9 = sample * this.channel2_scalefactor3;
               }

               filter1.input_sample(sample, this.subbandnumber);
               filter2.input_sample(var9, this.subbandnumber);
            } else if (channels == 1) {
               if (this.groupnumber <= 4) {
                  sample *= this.scalefactor1;
               } else if (this.groupnumber <= 8) {
