...
public class ConfirmButton {
    ...
    public ConfirmButton() {
        ...
        this.hb = new Hitbox(0.0f, 0.0f, 300.0f * Settings.scale, 100.0f * Settings.scale);
        this.updateText(CardSelectConfirmButton.TEXT[0]);
    ...
    private void renderControllerUi(SpriteBatch sb) {
        if (Settings.isControllerMode) {
            sb.setColor(Color.WHITE);
            sb.draw(CInputActionSet.select.getKeyImg(), this.current_x - 32.0f - this.controller_offset_x + 96.0f * Settings.scale, DRAW_Y - 32.0f + 57.0f * Settings.scale, 32.0f, 32.0f, 64.0f, 64.0f, Settings.scale, Settings.scale, 0.0f, 0, 0, 64, 64, false, false);
        }
    }
}
