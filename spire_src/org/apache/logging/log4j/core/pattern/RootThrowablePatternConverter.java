...
public final class RootThrowablePatternConverter extends ThrowablePatternConverter {
   ...
   public void format(final LogEvent event, final StringBuilder toAppendTo) {
      ...
      if (throwable != null && this.options.anyLines()) {
         ...
         String trace = proxy.getCauseStackTraceAsString(
            this.options.getIgnorePackages(), this.options.getTextRenderer(), this.getSuffix(event), this.options.getSeparator()
         );
