...
extends AbstractCard {
    ...
    public CoreSurge() {
        super(ID, CoreSurge.cardStrings.NAME, "blue/attack/core_surge", 1, CoreSurge.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.BLUE, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.ENEMY);
        this.exhaust = true;
        this.baseDamage = 11;
