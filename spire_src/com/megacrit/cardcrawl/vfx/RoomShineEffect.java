...
extends AbstractGameEffect {
    ...
    public RoomShineEffect() {
        this.duration = this.effectDuration = MathUtils.random(2.0f, 3.0f);
        this.startingDuration = this.effectDuration;
        this.x = MathUtils.random(50.0f, 1870.0f) * Settings.scale - (float)this.img.packedWidth / 2.0f;
        this.y = MathUtils.random((float)Settings.HEIGHT * 0.1f, (float)Settings.HEIGHT * 0.85f) - (float)this.img.packedHeight / 2.0f;
