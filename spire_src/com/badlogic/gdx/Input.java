...
public interface Input {
   ...
   int getDeltaY(int var1);

   boolean isTouched();

   boolean justTouched();

   boolean isTouched(int var1);

   boolean isButtonPressed(int var1);

   boolean isKeyPressed(int var1);

   boolean isKeyJustPressed(int var1);

   void getTextInput(Input.TextInputListener var1, String var2, String var3, String var4);

   void setOnscreenKeyboardVisible(boolean var1);

   void vibrate(int var1);

   void vibrate(long[] var1, int var2);
   ...
   void getRotationMatrix(float[] var1);

   long getCurrentEventTime();

   void setCatchBackKey(boolean var1);

   boolean isCatchBackKey();

   void setCatchMenuKey(boolean var1);

   boolean isCatchMenuKey();

   void setInputProcessor(InputProcessor var1);

   InputProcessor getInputProcessor();

   boolean isPeripheralAvailable(Input.Peripheral var1);

   int getRotation();

   Input.Orientation getNativeOrientation();

   void setCursorCatched(boolean var1);
