...
extends AbstractCard {
    ...
    public Magnetism() {
        super(ID, Magnetism.cardStrings.NAME, "colorless/power/magnetism", 2, Magnetism.cardStrings.DESCRIPTION, AbstractCard.CardType.POWER, AbstractCard.CardColor.COLORLESS, AbstractCard.CardRarity.RARE, AbstractCard.CardTarget.SELF);
