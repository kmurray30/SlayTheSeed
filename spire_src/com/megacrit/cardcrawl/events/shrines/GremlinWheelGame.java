...
public class GremlinWheelGame extends AbstractImageEvent {
   ...
   private GremlinWheelGame.CUR_SCREEN screen = GremlinWheelGame.CUR_SCREEN.INTRO;
   private int result;
   ...
   public void update() {
      ...
      if (this.startSpin && this.bounceTimer == 0.0F && this.buttonPressed) {
         ...
         if (this.animTimer > 0.0F) {
            ...
            this.wheelAngle = this.wheelAngle + this.spinVelocity * Gdx.graphics.getDeltaTime();
         } else {
         ...
         if (this.animTimer > 0.0F) {
            ...
            this.screen = GremlinWheelGame.CUR_SCREEN.COMPLETE;
         }
      }
   ...
   private void updatePosition() {
      if (this.bounceTimer != 0.0F) {
         this.bounceTimer = this.bounceTimer - Gdx.graphics.getDeltaTime();
         if (this.bounceTimer < 0.0F) {
   ...
   protected void buttonEffect(int buttonPressed) {
      switch (this.screen) {
         ...
         case COMPLETE:
            ...
            this.screen = GremlinWheelGame.CUR_SCREEN.LEAVE;
            break;
         case LEAVE:
            this.openMap();
            break;
   ...
   public void render(SpriteBatch sb) {
      ...
      sb.draw(
         this.arrowImg,
         this.imgX - 256.0F + ARROW_OFFSET_X + 180.0F * Settings.scale,
         this.imgY - 256.0F,
         256.0F,
         256.0F,
         512.0F,
      ...
      if (this.buttonHb.hovered) {
         sb.draw(
            this.buttonImg,
            this.buttonHb.cX - 256.0F,
            this.buttonHb.cY - 256.0F,
            256.0F,
            256.0F,
            512.0F,
            512.0F,
            Settings.scale * 1.05F,
            Settings.scale * 1.05F,
            0.0F,
            0,
            0,
      ...
      if (Settings.isControllerMode) {
         sb.draw(
            ...
            this.buttonHb.cX - 32.0F - 160.0F * Settings.scale,
            this.buttonHb.cY - 32.0F - 70.0F * Settings.scale,
            32.0F,
            32.0F,
            64.0F,
            64.0F,
