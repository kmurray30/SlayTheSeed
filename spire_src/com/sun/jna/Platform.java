...
public final class Platform {
   ...
   static boolean isSoftFloat() {
      try {
         ...
         Logger.getLogger(Platform.class.getName()).log(Level.INFO, "Failed to read '/proc/self/exe' or the target binary.", (Throwable)var2);
      } catch (SecurityException var3) {
         Logger.getLogger(Platform.class.getName())
            .log(Level.INFO, "SecurityException while analysing '/proc/self/exe' or the target binary.", (Throwable)var3);
      }
