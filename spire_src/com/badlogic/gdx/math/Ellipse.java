...
public class Ellipse implements Serializable, Shape2D {
   ...
   public float circumference() {
      ...
      return !(a * 3.0F > b) && !(b * 3.0F > a)
         ? (float)((float) (Math.PI * 2) * Math.sqrt((a * a + b * b) / 2.0F))
         : (float)((float) Math.PI * (3.0F * (a + b) - Math.sqrt((3.0F * a + b) * (a + 3.0F * b))));
   }
   ...
   public int hashCode() {
      ...
      return 53 * result + NumberUtils.floatToRawIntBits(this.y);
   }
}
