...
public class PotionBounceEffect
extends AbstractGameEffect {
    ...
    public void render(SpriteBatch sb) {
        ...
        for (int i = 5; i < this.previousPos.size(); ++i) {
            sb.draw(ImageMaster.POWER_UP_2, this.previousPos.get((int)i).x - (float)(PotionBounceEffect.img.packedWidth / 2), this.previousPos.get((int)i).y - (float)(PotionBounceEffect.img.packedHeight / 2), (float)PotionBounceEffect.img.packedWidth / 2.0f, (float)PotionBounceEffect.img.packedHeight / 2.0f, PotionBounceEffect.img.packedWidth, PotionBounceEffect.img.packedHeight, this.scale / (40.0f / (float)i), this.scale / (40.0f / (float)i), this.rotation);
        }
        sb.setColor(this.color);
        sb.draw(img, this.cX - (float)(PotionBounceEffect.img.packedWidth / 2), this.cY - (float)(PotionBounceEffect.img.packedHeight / 2) + this.yOffset, (float)PotionBounceEffect.img.packedWidth / 2.0f, (float)PotionBounceEffect.img.packedHeight / 2.0f, PotionBounceEffect.img.packedWidth, PotionBounceEffect.img.packedHeight, this.scale, this.scale, this.rotation);
        sb.draw(img, this.cX - (float)(PotionBounceEffect.img.packedWidth / 2), this.cY - (float)(PotionBounceEffect.img.packedHeight / 2) + this.yOffset, (float)PotionBounceEffect.img.packedWidth / 2.0f, (float)PotionBounceEffect.img.packedHeight / 2.0f, PotionBounceEffect.img.packedWidth, PotionBounceEffect.img.packedHeight, this.scale, this.scale, this.rotation);
