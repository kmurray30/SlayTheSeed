...
final class StateTracker {
   ...
   private final FastIntMap<StateTracker.VAOState> vaoMap = new FastIntMap<>();
   ...
   static int getElementArrayBufferBound(ContextCapabilities caps) {
      BaseReferences references = getReferences(caps);
      return references.vertexArrayObject == 0 ? references.elementArrayBuffer : caps.tracker.vaoMap.get(references.vertexArrayObject).elementArrayBuffer;
   }
