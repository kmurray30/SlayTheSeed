...
extends AbstractCard {
    ...
    public Defend_Green() {
        super(ID, Defend_Green.cardStrings.NAME, "green/skill/defend", 1, Defend_Green.cardStrings.DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.GREEN, AbstractCard.CardRarity.BASIC, AbstractCard.CardTarget.SELF);
        this.baseBlock = 5;
