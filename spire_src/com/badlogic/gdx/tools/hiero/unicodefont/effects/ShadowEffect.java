...
implements ConfigurableEffect {
    ...
    public List getValues() {
        ...
        values.add(EffectUtil.floatValue("X distance", this.xDistance, -99.0f, 99.0f, "This setting is the amount of pixels to offset the shadow on the x axis. The glyphs will need padding so the shadow doesn't get clipped."));
        values.add(EffectUtil.floatValue("Y distance", this.yDistance, -99.0f, 99.0f, "This setting is the amount of pixels to offset the shadow on the y axis. The glyphs will need padding so the shadow doesn't get clipped."));
