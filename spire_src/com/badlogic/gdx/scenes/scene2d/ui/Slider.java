...
public class Slider extends ProgressBar {
   ...
   public Slider(float min, float max, float stepSize, boolean vertical, Skin skin) {
      this(min, max, stepSize, vertical, skin.get("default-" + (vertical ? "vertical" : "horizontal"), Slider.SliderStyle.class));
   }

   public Slider(float min, float max, float stepSize, boolean vertical, Skin skin, String styleName) {
      this(min, max, stepSize, vertical, skin.get(styleName, Slider.SliderStyle.class));
   }
   ...
   public void setStyle(Slider.SliderStyle style) {
      ...
      } else if (!(style instanceof Slider.SliderStyle)) {
   ...
   protected Drawable getKnobDrawable() {
      ...
      return this.disabled && style.disabledKnob != null
         ? style.disabledKnob
         : (this.isDragging() && style.knobDown != null ? style.knobDown : (this.mouseOver && style.knobOver != null ? style.knobOver : style.knob));
   }
