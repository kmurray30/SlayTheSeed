...
public class SpookyChestEffect
extends AbstractGameEffect {
    ...
    public SpookyChestEffect() {
        this.startingDuration = this.duration = MathUtils.random(4.0f, 7.0f);
        ...
        this.x = AbstractChest.CHEST_LOC_X - (float)this.img.packedWidth / 2.0f;
        this.y = AbstractChest.CHEST_LOC_Y - (float)this.img.packedWidth / 2.0f - 150.0f * Settings.scale;
