...
public class SteamMatchmakingServers extends SteamInterface {
   ...
   public SteamServerListRequest requestInternetServerList(
      ...
      return new SteamServerListRequest(
         SteamMatchmakingServersNative.requestInternetServerList(appID, filters, filters.length, requestServersResponse.callback)
      );
   }
   ...
   public SteamServerListRequest requestFavoritesServerList(
      ...
      return new SteamServerListRequest(
         SteamMatchmakingServersNative.requestFavoritesServerList(appID, filters, filters.length, requestServersResponse.callback)
      );
   }
   ...
   public SteamServerListRequest requestSpectatorServerList(
      ...
      return new SteamServerListRequest(
         SteamMatchmakingServersNative.requestSpectatorServerList(appID, filters, filters.length, requestServersResponse.callback)
      );
   }
