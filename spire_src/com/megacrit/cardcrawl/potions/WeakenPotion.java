...
extends AbstractPotion {
    ...
    public WeakenPotion() {
        super(WeakenPotion.potionStrings.NAME, POTION_ID, AbstractPotion.PotionRarity.COMMON, AbstractPotion.PotionSize.H, AbstractPotion.PotionColor.WEAK);
        this.isThrown = true;
    ...
    public void initializeData() {
        ...
        this.description = WeakenPotion.potionStrings.DESCRIPTIONS[0] + this.potency + WeakenPotion.potionStrings.DESCRIPTIONS[1];
        this.tips.clear();
