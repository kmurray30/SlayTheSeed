...
public class Dialog extends Window {
   ...
   private void initialize() {
      ...
      this.row();
      this.add(this.buttonTable = new Table(this.skin)).fillX();
         ...
         private void focusChanged(FocusListener.FocusEvent event) {
            ...
            if (Dialog.this.isModal && stage != null && stage.getRoot().getChildren().size > 0 && stage.getRoot().getChildren().peek() == Dialog.this) {
               ...
               if (newFocusedActor != null
                  ...
                  && !newFocusedActor.equals(Dialog.this.previousKeyboardFocus)
                  && !newFocusedActor.equals(Dialog.this.previousScrollFocus)) {
                  event.cancel();
               }
            }
         }
