...
public final class ARBVertexShader {
    ...
    public static int glGetActiveAttribSizeARB(int programObj, int index) {
        ...
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, 0, 0L, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer);
        return size.get(0);
    }
    ...
    public static int glGetActiveAttribTypeARB(int programObj, int index) {
        ...
        ARBVertexShader.nglGetActiveAttribARB(programObj, index, 0, 0L, MemoryUtil.getAddress(type, 1), MemoryUtil.getAddress(type), APIUtil.getBufferByte0(caps), function_pointer);
        return type.get(0);
    }
