...
public class RemapInputElement implements HitboxListener, InputProcessor {
   ...
   public void render(SpriteBatch sb) {
      if (!this.isHidden) {
         ...
         FontHelper.renderFont(sb, FontHelper.topPanelInfoFont, this.getKeyColumnText(), textX, textY, textColor);
         ...
         if (!this.isHeader) {
            ...
            if (img != null) {
               sb.draw(
                  img,
                  textX - 32.0F,
                  textY - 32.0F - 10.0F * Settings.scale,
                  32.0F,
                  32.0F,
                  64.0F,
                  64.0F,
