...
public class TideMapLoader extends SynchronousAssetLoader<TiledMap, TideMapLoader.Parameters> {
   ...
   public TiledMap load(AssetManager assetManager, String fileName, FileHandle tideFile, TideMapLoader.Parameters parameter) {
      try {
   ...
   public Array<AssetDescriptor> getDependencies(String fileName, FileHandle tmxFile, TideMapLoader.Parameters parameter) {
         ...
         for (int rowCount = rows.size; row < rowCount; row++) {
            ...
            for (int childCount = currentRow.getChildCount(); child < childCount; child++) {
               ...
               if (name.equals("TileSheet")) {
                  ...
                  TiledMapTileLayer.Cell cell = new TiledMapTileLayer.Cell();
                  cell.setTile(new AnimatedTiledMapTile(interval / 1000.0F, frameTiles));
                  layer.setCell(x++, y, cell);
               }
            }
         }
