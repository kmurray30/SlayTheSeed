...
public final class ARBShaderObjects {
   ...
   public static int glGetHandleARB(int pname) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetHandleARB(pname, function_pointer);
   }
   ...
   public static int glCreateShaderObjectARB(int shaderType) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglCreateShaderObjectARB(shaderType, function_pointer);
   }
   ...
   public static int glCreateProgramObjectARB() {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglCreateProgramObjectARB(function_pointer);
   }
   ...
   public static String glGetInfoLogARB(int obj, int maxLength) {
      ...
      ((Buffer)infoLog).limit(infoLog_length.get(0));
   ...
   public static int glGetUniformLocationARB(int programObj, ByteBuffer name) {
      ...
      return nglGetUniformLocationARB(programObj, MemoryUtil.getAddress(name), function_pointer);
   }
   ...
   public static int glGetUniformLocationARB(int programObj, CharSequence name) {
      ...
      long function_pointer = caps.glGetUniformLocationARB;
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglGetUniformLocationARB(programObj, APIUtil.getBufferNT(caps, name), function_pointer);
   }
   ...
   public static int glGetActiveUniformSizeARB(int programObj, int index) {
      ...
      nglGetActiveUniformARB(
         programObj, index, 0, 0L, MemoryUtil.getAddress(size), MemoryUtil.getAddress(size, 1), APIUtil.getBufferByte0(caps), function_pointer
      );
      return size.get(0);
   }
   ...
   public static int glGetActiveUniformTypeARB(int programObj, int index) {
      ...
      nglGetActiveUniformARB(
         programObj, index, 0, 0L, MemoryUtil.getAddress(type, 1), MemoryUtil.getAddress(type), APIUtil.getBufferByte0(caps), function_pointer
      );
      return type.get(0);
   }
   ...
   public static String glGetShaderSourceARB(int obj, int maxLength) {
      ...
      ((Buffer)source).limit(source_length.get(0));
