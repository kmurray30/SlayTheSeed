...
extends AbstractCard {
    ...
    public Madness() {
        super(ID, Madness.cardStrings.NAME, "colorless/skill/madness", 1, Madness.cardStrings.DESCRIPTION, AbstractCard.CardType.SKILL, AbstractCard.CardColor.COLORLESS, AbstractCard.CardRarity.UNCOMMON, AbstractCard.CardTarget.SELF);
        this.exhaust = true;
    }
