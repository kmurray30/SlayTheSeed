...
public class VictoryScreen extends GameOverScreen {
   ...
   private void updateVfx() {
      switch (AbstractDungeon.player.chosenClass) {
         case IRONCLAD:
            this.effectTimer = this.effectTimer - Gdx.graphics.getDeltaTime();
         ...
         case THE_SILENT:
            ...
            this.effectTimer2 = this.effectTimer2 + Gdx.graphics.getDeltaTime();
         ...
         case WATCHER:
            ...
            for (AbstractGameEffect ex : this.effect) {
               if (ex instanceof WatcherVictoryEffect) {
                  createdEffect = true;
                  break;
               }
            }
