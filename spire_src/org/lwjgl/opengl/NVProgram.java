...
public class NVProgram {
   ...
   public static boolean glIsProgramNV(int programID) {
      ...
      BufferChecks.checkFunctionAddress(function_pointer);
      return nglIsProgramNV(programID, function_pointer);
   }
   ...
   public static boolean glAreProgramsResidentNV(IntBuffer programIDs, ByteBuffer programResidences) {
      ...
      return nglAreProgramsResidentNV(programIDs.remaining(), MemoryUtil.getAddress(programIDs), MemoryUtil.getAddress(programResidences), function_pointer);
   }
