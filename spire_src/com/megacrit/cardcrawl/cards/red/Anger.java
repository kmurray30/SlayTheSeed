...
extends AbstractCard {
    ...
    public Anger() {
        super(ID, Anger.cardStrings.NAME, "red/attack/anger", 0, Anger.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.RED, AbstractCard.CardRarity.COMMON, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 6;
    }
