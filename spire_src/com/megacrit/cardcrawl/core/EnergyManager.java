...
public class EnergyManager {
    ...
    public void recharge() {
        if (AbstractDungeon.player.hasRelic("Ice Cream")) {
            ...
            if (EnergyPanel.totalCount > 0) {
                AbstractDungeon.actionManager.addToTop(new ReducePowerAction((AbstractCreature)AbstractDungeon.player, (AbstractCreature)AbstractDungeon.player, "Conserve", 1));
            }
            EnergyPanel.addEnergy(this.energy);
        } else {
