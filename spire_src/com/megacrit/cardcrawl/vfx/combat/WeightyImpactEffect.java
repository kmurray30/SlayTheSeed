...
public class WeightyImpactEffect extends AbstractGameEffect {
               ...
               AbstractDungeon.effectsQueue
                  .add(
                     new UpgradeShineParticleEffect(
                        ...
                        this.y + MathUtils.random(-50.0F, 120.0F) * Settings.scale + img.packedHeight / 2.0F
                     )
                  );
            }
         }
   ...
   public void render(SpriteBatch sb) {
      ...
      sb.draw(
         img,
         this.x,
         this.y + 40.0F * Settings.scale,
         img.packedWidth / 2.0F,
         img.packedHeight / 2.0F,
         img.packedWidth,
         img.packedHeight * (this.duration + 0.2F) * 5.0F,
         this.scale * MathUtils.random(0.99F, 1.01F) * 0.7F,
         this.scale * MathUtils.random(0.99F, 1.01F) * 1.3F * (this.duration + 0.8F),
         this.rotation
      );
      this.color.g = 0.2F;
      sb.setColor(this.color);
      sb.draw(
         ...
         this.scale * MathUtils.random(0.99F, 1.01F) * (this.duration + 0.8F),
         this.rotation
      );
