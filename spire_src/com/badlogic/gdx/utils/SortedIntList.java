...
public class SortedIntList<E> implements Iterable<SortedIntList.Node<E>> {
   ...
   public E insert(int index, E value) {
      if (this.first != null) {
         SortedIntList.Node<E> c = this.first;
         ...
         if (index > c.index) {
            ...
            SortedIntList.Node<E> newFirst = this.nodePool.obtain(null, this.first, value, index);
   ...
   static class NodePool<E> extends Pool<SortedIntList.Node<E>> {
      ...
      public SortedIntList.Node<E> obtain(SortedIntList.Node<E> p, SortedIntList.Node<E> n, E value, int index) {
         SortedIntList.Node<E> newNode = (SortedIntList.Node<E>)super.obtain();
         newNode.p = p;
         newNode.n = n;
         newNode.value = value;
         newNode.index = index;
