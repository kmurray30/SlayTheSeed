...
public final class ATIFragmentShader {
   ...
   public static int glGenFragmentShadersATI(int range) {
      ...
      return nglGenFragmentShadersATI(range, function_pointer);
   }
   ...
   public static void glColorFragmentOp3ATI(
      int op, int dst, int dstMask, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod, int arg3, int arg3Rep, int arg3Mod
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
   ...
   static native void nglColorFragmentOp3ATI(
      int var0, int var1, int var2, int var3, int var4, int var5, int var6, int var7, int var8, int var9, int var10, int var11, int var12, long var13
   );
   ...
   public static void glAlphaFragmentOp3ATI(
      int op, int dst, int dstMod, int arg1, int arg1Rep, int arg1Mod, int arg2, int arg2Rep, int arg2Mod, int arg3, int arg3Rep, int arg3Mod
   ) {
      ContextCapabilities caps = GLContext.getCapabilities();
   ...
   static native void nglAlphaFragmentOp3ATI(
