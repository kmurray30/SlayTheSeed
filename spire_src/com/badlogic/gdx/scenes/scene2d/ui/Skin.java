...
public class Skin implements Disposable {
   ...
   public <T> T optional(String name, Class<T> type) {
      if (name == null) {
         ...
         ObjectMap<String, Object> typeResources = this.resources.get(type);
         return (T)(typeResources == null ? null : typeResources.get(name));
      }
   }
   ...
   public Array<TextureRegion> getRegions(String regionName) {
      ...
      if (region != null) {
         for (regions = new Array<>(); region != null; region = this.optional(regionName + "_" + i++, TextureRegion.class)) {
            regions.add(region);
         }
      }
   ...
   public String find(Object resource) {
      if (resource == null) {
         ...
         return typeResources == null ? null : typeResources.findKey(resource, true);
      }
   }
   ...
   public void dispose() {
      ...
      for (ObjectMap<String, Object> entry : this.resources.values()) {
   ...
   protected Json getJsonLoader(final FileHandle skinFile) {
      ...
      Json json = new Json() {
         ...
         public <T> T readValue(Class<T> type, Class elementType, JsonValue jsonData) {
            return jsonData.isString() && !ClassReflection.isAssignableFrom(CharSequence.class, type)
         ...
         public Color read(Json json, JsonValue jsonData, Class type) {
            if (jsonData.isString()) {
               ...
               if (hex != null) {
                  ...
                  float r = json.readValue("r", float.class, 0.0F, jsonData);
                  float g = json.readValue("g", float.class, 0.0F, jsonData);
                  float b = json.readValue("b", float.class, 0.0F, jsonData);
                  float a = json.readValue("a", float.class, 1.0F, jsonData);
