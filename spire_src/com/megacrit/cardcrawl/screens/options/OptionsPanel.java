...
public class OptionsPanel implements DropdownMenuListener, HitboxListener {
   ...
   private void updateGraphics() {
      ...
      if (this.fsToggle.hb.hovered) {
         TipHelper.renderGenericTip(Settings.WIDTH * 0.03F, this.fsToggle.hb.cY + 50.0F * Settings.scale, LABEL[1], MSG[1]);
      } else if (this.wfsToggle.hb.hovered) {
         TipHelper.renderGenericTip(Settings.WIDTH * 0.03F, this.wfsToggle.hb.cY + 50.0F * Settings.scale, LABEL[2], MSG[2]);
      } else if (this.fpsDropdown.getHitbox().hovered) {
         TipHelper.renderGenericTip(Settings.WIDTH * 0.03F, this.fpsDropdown.getHitbox().cY + 30.0F * Settings.scale, LABEL[3], MSG[3]);
      }
   }
   ...
   private void renderBg(SpriteBatch sb) {
      ...
      sb.draw(
         ImageMaster.INPUT_SETTINGS_EDGES,
      ...
      sb.draw(
         ImageMaster.SETTINGS_BACKGROUND,
         Settings.WIDTH / 2.0F - 960.0F,
         Settings.OPTION_Y - 540.0F,
         960.0F,
         540.0F,
      ...
      if (Settings.isControllerMode) {
         sb.draw(
            ...
            this.inputSettingsHb.cX - 32.0F + FontHelper.getSmartWidth(FontHelper.panelNameFont, TEXT[20], 99999.0F, 0.0F) / 2.0F + 42.0F * Settings.scale,
   ...
   private void renderBanner(SpriteBatch sb) {
      FontHelper.renderFontCentered(
         sb, FontHelper.panelNameFont, HEADER_TEXT, this.inputSettingsHb.cX - 396.0F * Settings.xScale, this.inputSettingsHb.cY, Settings.GOLD_COLOR
      );
   ...
   private void renderGraphics(SpriteBatch sb) {
      FontHelper.renderFontCentered(
         sb, FontHelper.panelNameFont, GRAPHICS_PANEL_HEADER_TEXT, 636.0F * Settings.xScale, SCREEN_CENTER_Y + 256.0F * Settings.scale, Settings.GOLD_COLOR
      );
      FontHelper.renderSmartText(
         ...
         RESOLUTION_TEXTS,
         LEFT_TEXT_X,
         SCREEN_CENTER_Y + 196.0F * Settings.scale,
         10000.0F,
      ...
      FontHelper.renderSmartText(
         ...
         FULLSCREEN_TEXTS,
         LEFT_TOGGLE_TEXT_X,
         SCREEN_CENTER_Y + 106.0F * Settings.scale,
         10000.0F,
   ...
   private void renderSound(SpriteBatch sb) {
      FontHelper.renderFontCentered(
         sb, FontHelper.panelNameFont, SOUND_PANEL_HEADER_TEXT, 1264.0F * Settings.xScale, SCREEN_CENTER_Y + 256.0F * Settings.scale, Settings.GOLD_COLOR
      );
      FontHelper.renderSmartText(
         sb,
         FontHelper.cardDescFont_N,
         VOLUME_TEXTS,
         1020.0F * Settings.xScale,
         SCREEN_CENTER_Y + 196.0F * Settings.scale,
         10000.0F,
         44.0F * Settings.scale,
         Settings.CREAM_COLOR
      );
      FontHelper.renderSmartText(
         sb,
         FontHelper.tipBodyFont,
         OTHER_SOUND_TEXTS,
         1056.0F * Settings.xScale,
         SCREEN_CENTER_Y + 66.0F * Settings.scale,
         10000.0F,
         34.8F * Settings.scale,
         Settings.CREAM_COLOR
      );
   ...
   private void renderPreferences(SpriteBatch sb) {
      FontHelper.renderFontCentered(
         sb, FontHelper.panelNameFont, PREF_PANEL_HEADER_TEXT, 636.0F * Settings.xScale, SCREEN_CENTER_Y - 60.0F * Settings.scale, Settings.GOLD_COLOR
      );
      FontHelper.renderSmartText(
         sb,
         FontHelper.tipBodyFont,
         PREF_TEXTS + " NL " + DISABLE_EFFECTS_TEXT + " NL " + FAST_MODE_TEXT + " NL " + SHOW_CARD_QUICK_SELECT_TEXT,
         456.0F * Settings.xScale,
         SCREEN_CENTER_Y - 112.0F * Settings.scale,
         10000.0F,
         34.8F * Settings.scale,
         Settings.CREAM_COLOR
      );
   ...
   private void renderMiscellaneous(SpriteBatch sb) {
      FontHelper.renderFontCentered(
         sb, FontHelper.panelNameFont, MISC_PANEL_HEADER_TEXT, 1264.0F * Settings.xScale, SCREEN_CENTER_Y - 60.0F * Settings.scale, Settings.GOLD_COLOR
      );
      FontHelper.renderSmartText(
         sb,
         FontHelper.cardDescFont_N,
         LANGUAGE_TEXT,
         1020.0F * Settings.xScale,
         SCREEN_CENTER_Y - 114.0F * Settings.scale,
         10000.0F,
         44.0F * Settings.scale,
         Settings.CREAM_COLOR
      );
      if (this.playtesterToggle != null) {
         FontHelper.renderSmartText(
            ...
            PLAYTESTER_ART_TEXT,
            1056.0F * Settings.xScale,
            SCREEN_CENTER_Y - 182.0F * Settings.scale,
            10000.0F,
            34.0F * Settings.scale,
            Settings.CREAM_COLOR
         );
      ...
      FontHelper.renderSmartText(
         ...
         UPLOAD_TEXT,
         1056.0F * Settings.xScale,
         SCREEN_CENTER_Y - 216.0F * Settings.scale,
         10000.0F,
         34.0F * Settings.scale,
         Settings.CREAM_COLOR
      );
      FontHelper.renderSmartText(
         ...
         LONGPRESS_TEXT,
         1056.0F * Settings.xScale,
         SCREEN_CENTER_Y - 250.0F * Settings.scale,
         10000.0F,
         34.0F * Settings.scale,
         Settings.CREAM_COLOR
      );
      FontHelper.renderSmartText(
         ...
         TEXT[26],
         1056.0F * Settings.xScale,
         SCREEN_CENTER_Y - 284.0F * Settings.scale,
         10000.0F,
         34.0F * Settings.scale,
         Settings.CREAM_COLOR
      );
   ...
   public String[] languageLabels() {
      if (Settings.isConsoleBuild) {
         return new String[]{
            LOCALIZED_LANGUAGE_LABELS[3],
            LOCALIZED_LANGUAGE_LABELS[0],
            LOCALIZED_LANGUAGE_LABELS[1],
            LOCALIZED_LANGUAGE_LABELS[2],
            LOCALIZED_LANGUAGE_LABELS[26],
            LOCALIZED_LANGUAGE_LABELS[4],
            LOCALIZED_LANGUAGE_LABELS[5],
            LOCALIZED_LANGUAGE_LABELS[24],
            LOCALIZED_LANGUAGE_LABELS[6],
            LOCALIZED_LANGUAGE_LABELS[7],
            LOCALIZED_LANGUAGE_LABELS[8],
            LOCALIZED_LANGUAGE_LABELS[9],
            LOCALIZED_LANGUAGE_LABELS[10],
            LOCALIZED_LANGUAGE_LABELS[11],
            LOCALIZED_LANGUAGE_LABELS[16],
            LOCALIZED_LANGUAGE_LABELS[13],
            LOCALIZED_LANGUAGE_LABELS[18],
         ...
         return !Settings.isBeta
            ? new String[]{
               ...
               LOCALIZED_LANGUAGE_LABELS[2],
               LOCALIZED_LANGUAGE_LABELS[26],
               LOCALIZED_LANGUAGE_LABELS[25],
               LOCALIZED_LANGUAGE_LABELS[27],
               LOCALIZED_LANGUAGE_LABELS[4],
               LOCALIZED_LANGUAGE_LABELS[5],
               LOCALIZED_LANGUAGE_LABELS[24],
               LOCALIZED_LANGUAGE_LABELS[6],
               ...
               LOCALIZED_LANGUAGE_LABELS[9],
               LOCALIZED_LANGUAGE_LABELS[10],
               LOCALIZED_LANGUAGE_LABELS[17],
               LOCALIZED_LANGUAGE_LABELS[21],
               LOCALIZED_LANGUAGE_LABELS[11],
               LOCALIZED_LANGUAGE_LABELS[16],
               LOCALIZED_LANGUAGE_LABELS[13],
               LOCALIZED_LANGUAGE_LABELS[18],
            ...
            : new String[]{
               ...
               LOCALIZED_LANGUAGE_LABELS[4],
               LOCALIZED_LANGUAGE_LABELS[5],
               LOCALIZED_LANGUAGE_LABELS[23],
               LOCALIZED_LANGUAGE_LABELS[24],
               LOCALIZED_LANGUAGE_LABELS[6],
               LOCALIZED_LANGUAGE_LABELS[7],
               LOCALIZED_LANGUAGE_LABELS[8],
               LOCALIZED_LANGUAGE_LABELS[15],
               LOCALIZED_LANGUAGE_LABELS[9],
               LOCALIZED_LANGUAGE_LABELS[10],
               LOCALIZED_LANGUAGE_LABELS[17],
               LOCALIZED_LANGUAGE_LABELS[21],
   ...
   public Settings.GameLanguage[] LanguageOptions() {
      if (Settings.isConsoleBuild) {
         return new Settings.GameLanguage[]{
            Settings.GameLanguage.ENG,
            Settings.GameLanguage.PTB,
            Settings.GameLanguage.ZHS,
            Settings.GameLanguage.ZHT,
            Settings.GameLanguage.DUT,
            Settings.GameLanguage.FRA,
            Settings.GameLanguage.DEU,
            Settings.GameLanguage.ITA,
            Settings.GameLanguage.ITA,
            Settings.GameLanguage.JPN,
            Settings.GameLanguage.KOR,
            Settings.GameLanguage.POL,
            Settings.GameLanguage.RUS,
            Settings.GameLanguage.SPA,
            Settings.GameLanguage.THA,
            Settings.GameLanguage.TUR,
            Settings.GameLanguage.UKR,
            Settings.GameLanguage.VIE
         };
      } else {
         return !Settings.isBeta
            ? new Settings.GameLanguage[]{
               Settings.GameLanguage.ENG,
               Settings.GameLanguage.PTB,
               Settings.GameLanguage.ZHS,
               Settings.GameLanguage.ZHT,
               Settings.GameLanguage.DUT,
               Settings.GameLanguage.EPO,
               Settings.GameLanguage.FIN,
               Settings.GameLanguage.FRA,
               Settings.GameLanguage.DEU,
               Settings.GameLanguage.IND,
               Settings.GameLanguage.ITA,
               Settings.GameLanguage.JPN,
               Settings.GameLanguage.KOR,
               Settings.GameLanguage.POL,
               Settings.GameLanguage.RUS,
               Settings.GameLanguage.SRP,
               Settings.GameLanguage.SRB,
               Settings.GameLanguage.SPA,
               Settings.GameLanguage.THA,
               Settings.GameLanguage.TUR,
               Settings.GameLanguage.UKR,
            ...
            : new Settings.GameLanguage[]{
               ...
               Settings.GameLanguage.FRA,
               Settings.GameLanguage.DEU,
               Settings.GameLanguage.GRE,
               Settings.GameLanguage.IND,
               Settings.GameLanguage.ITA,
               Settings.GameLanguage.JPN,
               Settings.GameLanguage.KOR,
               Settings.GameLanguage.NOR,
               Settings.GameLanguage.POL,
               Settings.GameLanguage.RUS,
               Settings.GameLanguage.SRP,
               Settings.GameLanguage.SRB,
   ...
   private void changeFrameRateToIndex(int index) {
      if (Settings.MAX_FPS != this.FRAMERATE_OPTIONS[index]) {
         ...
         DisplayConfig.writeDisplayConfigFile(
            Settings.SAVED_WIDTH, Settings.SAVED_HEIGHT, Settings.MAX_FPS, Settings.IS_FULLSCREEN, Settings.IS_W_FULLSCREEN, Settings.IS_V_SYNC
         );
         this.displayRestartRequiredText();
      }
   }
   ...
   private void changeResolutionToIndex(int index) {
      if (Settings.displayIndex != index) {
         ...
         int TMP_WIDTH = Settings.displayOptions.get(index).width;
         int TMP_HEIGHT = Settings.displayOptions.get(index).height;
   ...
   public void resetResolutionDropdownSelection() {
      ...
      for (int i = 0; i < Settings.displayOptions.size(); i++) {
         if (dConfig.getWidth() == Settings.displayOptions.get(i).width && dConfig.getHeight() == Settings.displayOptions.get(i).height) {
   ...
   private ArrayList<DisplayOption> getWindowedAndFullscreenResolutions() {
      ...
      for (Graphics.DisplayMode m : modes) {
         DisplayOption ox = new DisplayOption(m.width, m.height);
         if (!retVal.contains(ox) && ox.width >= 1024 && ox.height >= 576) {
            retVal.add(ox);
         }
      }
   ...
   public void setFullscreen(boolean borderless) {
      ...
      for (int i = 0; i < Settings.displayOptions.size(); i++) {
         if (Settings.displayOptions.get(i).equals(new DisplayOption(TMP_WIDTH, TMP_HEIGHT))) {
