...
extends AbstractCard {
    ...
    public Strike_Blue() {
        super(ID, Strike_Blue.cardStrings.NAME, "blue/attack/strike", 1, Strike_Blue.cardStrings.DESCRIPTION, AbstractCard.CardType.ATTACK, AbstractCard.CardColor.BLUE, AbstractCard.CardRarity.BASIC, AbstractCard.CardTarget.ENEMY);
        this.baseDamage = 6;
