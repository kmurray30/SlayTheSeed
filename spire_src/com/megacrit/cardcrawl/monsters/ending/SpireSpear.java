         ...
         case 3:
            for (int i = 0; i < this.skewerCount; i++) {
               ...
               AbstractDungeon.actionManager
                  .addToBottom(new DamageAction(AbstractDungeon.player, this.damage.get(1), AbstractGameAction.AttackEffect.SLASH_DIAGONAL, true));
            }
      }
      ...
      switch (this.moveCount % 3) {
         case 0:
            if (!this.lastMove((byte)1)) {
               this.setMove((byte)1, AbstractMonster.Intent.ATTACK_DEBUFF, this.damage.get(0).base, 2, true);
            } else {
               this.setMove((byte)2, AbstractMonster.Intent.BUFF);
            }
            break;
         case 1:
            this.setMove((byte)3, AbstractMonster.Intent.ATTACK, this.damage.get(1).base, this.skewerCount, true);
            break;
         default:
