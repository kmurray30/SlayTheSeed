...
public class BinTree extends InWindow {
   ...
   public int GetMatches(int[] distances) throws IOException {
      ...
      if (this.kNumHashDirectBytes != 0
         ...
         && this._bufferBase[this._bufferOffset + curMatch + this.kNumHashDirectBytes] != this._bufferBase[cur + this.kNumHashDirectBytes]) {
         int var31 = offset++;
         maxLen = this.kNumHashDirectBytes;
         distances[var31] = this.kNumHashDirectBytes;
