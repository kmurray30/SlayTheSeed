...
public class NtpV3Impl implements NtpV3Packet {
   ...
   public String getReferenceIdString() {
      ...
      return stratum >= 2 ? this.idAsIPAddress() : this.idAsHex();
   }
   ...
   private void setTimestamp(int index, TimeStamp t) {
      ...
      for (int i = 7; i >= 0; i--) {
         this.buf[index + i] = (byte)(ntpTime & 255L);
         ntpTime >>>= 8;
      }
   }
   ...
   public String toString() {
      return "[version:"
         ...
         + this.getRootDelay()
         + ", dispersion(ms):"
         + this.getRootDispersionInMillisDouble()
         + ", id:"
         + this.getReferenceIdString()
         + ", xmitTime:"
         + this.getTransmitTimeStamp().toDateString()
         + " ]";
   }
}
